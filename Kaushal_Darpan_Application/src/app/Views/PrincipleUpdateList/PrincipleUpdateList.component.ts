...
import { UserPrincipMasterSerchModel, PrincipleUpdateInstituteIDModel } from '../../Models/UserMasterDataModel';
...
@Component({
  ...
  templateUrl: './PrincipleUpdateList.Component.html',
  styleUrl: './PrincipleUpdateList.Component.css'
})
export class PrincipleUpdateListComponent {
  ...
  public requestUserMasterSerchModel = new UserPrincipMasterSerchModel();//search
  ...
  async GetAllPrinciple() {
    ...
    try {
      ...
      this.requestUserMasterSerchModel.RoleId = EnumRole.Principal 
      await this.UserMasterService.GetPrincipleList(this.requestUserMasterSerchModel)
        .then(async (data: any) => {
  ...
  async btn_Update() {
    ...
    if (this.requestPrincipleUpdateInstituteIDModel.json_Data != "[]" ) {
      try {
        const data: any = await this.UserMasterService.UpdatePrincipleData(this.requestPrincipleUpdateInstituteIDModel);
        if (data.State === EnumStatus.Success) {
  ...
  async btn_Clear() {
    this.requestUserMasterSerchModel = new UserPrincipMasterSerchModel();
