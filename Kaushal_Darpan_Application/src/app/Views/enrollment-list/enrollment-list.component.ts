...
import { EnrollmentListService } from '../../Services/EnrollmentList/enrollment-list.service';
...
import { EnrollmentListDataModel, EnrollmentListSearchModel } from '../../Models/EnrollmentListDataModel';
...
export class EnrollmentListComponent {
  ...
  request = new EnrollmentListDataModel()
  public searchRequest = new EnrollmentListSearchModel();
  public InstituteList: any = [];

  constructor(private commonMasterService: CommonFunctionService, private EnrollmentListService: EnrollmentListService,
