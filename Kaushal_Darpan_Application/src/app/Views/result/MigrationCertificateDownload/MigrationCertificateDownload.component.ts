...
@Component({
  selector: 'app-MigrationCertificateDownload',
  templateUrl: './MigrationCertificateDownload.component.html',
  styleUrls: ['./MigrationCertificateDownload.component.css'],
  standalone: false
})
export class MigrationCertificateDownloadComponent {
  ...
  async getAllData() {
    ...
    try {
      ...
      // get
      await this.marksheetDownloadService.GetStudentsMigrationDiplomaCertificate(this.searchRequest)
        .then(async (data: any) => {
          data = JSON.parse(JSON.stringify(data));
