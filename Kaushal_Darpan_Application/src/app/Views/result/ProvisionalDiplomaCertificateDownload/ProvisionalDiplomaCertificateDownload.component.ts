...
import { ProvisionalDiplomaCertificateDownloadSearchModel, DownloadMarksheetSearchModel } from '../../../Models/DownloadMarksheetDataModel';
...
@Component({
  selector: 'app-ProvisionalDiplomaCertificateDownload',
  templateUrl: './ProvisionalDiplomaCertificateDownload.component.html',
  styleUrls: ['./ProvisionalDiplomaCertificateDownload.component.css'],
  standalone: false
})
export class ProvisionalDiplomaCertificateDownloadComponent {
  public InstituteMasterList: any = [];
  public SemesterMasterList: any = [];
  public ResultTypeList: any = [];
  sSOLoginDataModel = new SSOLoginDataModel();
  public isSubmitted = false;
  public searchRequest = new ProvisionalDiplomaCertificateDownloadSearchModel();
  public downloadReq = new ProvisionalDiplomaCertificateDownloadSearchModel();
  ...
  async getAllData() {
    ...
    try {
      ...
      // get
      await this.marksheetDownloadService.GetStudentsProvisionalDiplomaCertificate(this.searchRequest)
        .then(async (data: any) => {
          data = JSON.parse(JSON.stringify(data));
  ...
  async DownloadChunkDiplomaCertificate(start: number, end: number) {
    ...
    try {
      ...
      // make file and save
      await this.reportService.StudentProvisionalDiplomaCertificateDownloadChunk(StudentList)
        .then(async (data: any) => {
          data = JSON.parse(JSON.stringify(data));
  ...
  onCancel(){
    ...
    this.searchRequest.IsBridge = -1;
    this.searchRequest.ResultTypeID = 0;
    this.searchRequest.EndTermID = 0;
    this.searchRequest.SchemeID = 0;
