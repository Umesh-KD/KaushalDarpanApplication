...
@Component({
    selector: 'student-correction-master',
    templateUrl: './student-correction-master.component.html',
    styleUrls: ['./student-correction-master.component.css'],
    standalone: false
})
export class StudentCorrectionMasterComponent implements OnInit {
