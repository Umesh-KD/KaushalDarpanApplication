...
@Component({
  selector: 'app-industry-institute-partnership-validation',
  standalone: false,
  templateUrl: './industry-institute-partnership-validation.component.html',
  styleUrl: './industry-institute-partnership-validation.component.css'
})
export class IndustryInstitutePartnershipValidationComponent {
  ...
  async ViewandUpdate(content: any, ID: number) {
    ...
    this.modalReference = this.modalService.open(IndustryInstitutePartnershipMasterComponent, { backdrop: 'static', size: 'xl', keyboard: true, centered: true });
