...
export class ITIExaminationPublicInfoTabsComponent implements OnInit {
  ...
  async LoadTabs() {
    ...
    this.tabs.push({ TabName: 'Know your Revaluation by Appication No', TabNameHI: 'आवेदन संख्या द्वारा पुनर्मूल्यांकन के बारे में जानें', TabIcon: 'ti ti-license', component: KnowRevealuationITIComponent, DepartmentID: 2, CourseTypeId: 1, Enable: false, HasLink: false });
