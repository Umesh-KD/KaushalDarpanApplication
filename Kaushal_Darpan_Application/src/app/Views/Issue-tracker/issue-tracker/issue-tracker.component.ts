...
//    this.searchrequest.PriorityID = this.selectPriorityID;
//    this.searchrequest.Status = this.selectStatus;
///*    this.searchrequest.PriorityID = this.priorityList; */
//    try {
//      await this.Issuetrackerservice.GetAllData(this.searchrequest).then((data: any) => {
//        data = JSON.parse(JSON.stringify(data));
//        this.issuelist = data.Data;
//        this.backupFinalList = this.issuelist;
//       // console.log(this.issuelist);
//        console.log("this.ExaminersList", this.issuelist)
//      })
//    } catch (error) {
//      console.error(error);
//    }
