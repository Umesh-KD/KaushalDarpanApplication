...
@Component({
  selector: 'app-principle-menu-right',
  standalone: false,
  templateUrl: './principle-menu-right.component.html',
  styleUrl: './principle-menu-right.component.css'
})
export class PrincipleMenuRightComponent {
  ...
  async GetAllMenuList(id: number) {
    try {
      ...
      await this.UserMenuRightsService.GetAllMenuPrincipleRoleRights(model)
        .then((data: any) => {
      ...
      await this.UserMenuRightsService.SaveUserRightData(this.MenuList)
        .then((data: any) => {
          ...
          if (this.State == EnumStatus.Success) {
            ...
            this.routers.navigate(['/AdminUser']);
          }
          else {
