...
export class GroupsComponent implements OnInit {
  ...
  public searchRequest = new GroupSearchModel();
  sSOLoginDataModel = new SSOLoginDataModel();

  constructor(private commonMasterService: CommonFunctionService, private Router: Router, private GroupServices: GroupService, private toastr: ToastrService,
  ...
  async GetGroupList() {
    ...
    try {
      this.loaderService.requestStarted();
      await this.GroupServices.GetAllData(this.searchRequest)
        .then((data: any) => {
          data = JSON.parse(JSON.stringify(data));
          this.State = data['State'];
          this.Message = data['Message'];
          this.ErrorMessage = data['ErrorMessage'];
          this.GroupMasterList = data['Data'];
          console.log(this.GroupMasterList, "GroupMaster")
  ...
  ResetControl() {
    ...
    this.searchRequest = new GroupSearchModel();
  ...
  onSearchClick() {
    ...
    this.GroupMasterList = this.GroupMasterList.filter((college: any) => {
