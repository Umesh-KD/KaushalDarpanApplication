...
import { RenumerationAccountsRequestModel, RenumerationAccountsModel, RenumerationAccountsSaveModel } from '../../Models/RenumerationAccountsModel';
import { SSOLoginDataModel } from '../../Models/SSOLoginDataModel';
import { LoaderService } from '../../Services/Loader/loader.service';
import { ReportService } from '../../Services/Report/report.service';
import { RenumerationAccountsRevalService } from '../../Services/renumeration-accounts-reval/renumeration-accounts-reval.service';

@Component({
  selector: 'app-renumeration-accounts-reval',
  standalone: false,
  templateUrl: './renumeration-accounts-reval.component.html',
  styleUrl: './renumeration-accounts-reval.component.css'
})
export class RenumerationAccountsRevalComponent {
  public Message: any = [];
  ...
  constructor(private commonMasterService: CommonFunctionService,
    ...
    private renumerationAccountsRevalService: RenumerationAccountsRevalService,
  ...
  async GetAllData() {
    try {
      ...
      //call
      await this.renumerationAccountsRevalService.GetAllData(this.RenumerationAccountsRequest)
        .then(async (data: any) => {
  ...
  async SaveDataApprovedFromAccounts() {
    ...
    try {
      ...
      await this.renumerationAccountsRevalService.SaveDataApprovedFromAccounts(this.requestAddMore)
        .then(async (data: any) => {
          if (data.State == EnumStatus.Error) {
            this.toastr.error(data.Message);
            console.log(data.ErrorMessage);
  ...
  async UpdateDataApprovedFromAccounts() {
    ...
    try {
      ...
      await this.renumerationAccountsRevalService.UpdateDataApprovedFromAccounts(this.AccountsSave)
        .then(async (data: any) => {
          if (data.State == EnumStatus.Error) {
            this.toastr.error(data.Message);
            console.log(data.ErrorMessage);
