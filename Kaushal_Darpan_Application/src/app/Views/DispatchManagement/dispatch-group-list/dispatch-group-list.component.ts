...
@Component({
  selector: 'app-dispatch-group-list',
  standalone: false,
  templateUrl: './dispatch-group-list.component.html',
  styleUrl: './dispatch-group-list.component.css'
})
export class DispatchGroupListComponent {
  ...
  async CheckOtpAfterSave() {
    ...
    await this.DispatchService.OnSTatusUpdate(Selected).then(
      (data: any) => {
