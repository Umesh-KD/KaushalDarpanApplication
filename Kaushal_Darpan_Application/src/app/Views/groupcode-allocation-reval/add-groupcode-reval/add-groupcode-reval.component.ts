...
@Component({
  selector: 'app-add-groupcode-reval',
  templateUrl: './add-groupcode-reval.component.html',
  styleUrls: ['./add-groupcode-reval.component.css'],
  standalone: false
})
export class GroupcodeAddRevalComponent
{
  public Message: any = [];
  ...
  async GetSerialMasterData() {
    try {
      ...
      this.requestSerialMaster.FinancialYearID = this.sSOLoginDataModel.FinancialYearID;
