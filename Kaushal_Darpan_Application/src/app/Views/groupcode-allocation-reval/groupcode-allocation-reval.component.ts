...
@Component({
  selector: 'app-groupcode-allocation-reval',
  templateUrl: './groupcode-allocation-reval.component.html',
  styleUrls: ['./groupcode-allocation-reval.component.css'],
  standalone: false
})
export class GroupcodeAllocationRevalComponent {
  public Message: any = [];
  ...
  async GetSerialMasterData() {
    try {
      //set
      this.requestSerialMaster.TypeID = EnumConfigurationType.Reval_GroupCode;
