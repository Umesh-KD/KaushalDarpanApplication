...
import { M_StudentMaster_QualificationDetailsModel, StudentMarkedModel, StudentEnrollmentApprovalReject, Student_DataModel, StudentRejectMarkedModel } from '../../Models/StudentEnrollmentApprovalRejectModels';
import { ModalDismissReasons, NgbModal, NgbModalRef } from '@ng-bootstrap/ng-bootstrap';
import { DropdownValidators } from '../../Services/CustomValidators/custom-validators.service';
import { FormBuilder, FormGroup, Validators } from '@angular/forms';
import { CommonFunctionService } from '../../Services/CommonFunction/common-function.service';
import { StudentEnrollmentApprovalRejectService } from '../../Services/Student-Enrollment-Approval-Reject/student-enrollment-approval-reject.service';
...
@Component({
  selector: 'app-student-enrollment-approval-reject',
  standalone: false,
  
  templateUrl: './student-enrollment-approval-reject.component.html',
  styleUrl: './student-enrollment-approval-reject.component.css'
})
export class StudentEnrollmentApprovalRejectComponent {
  ...
  public PreExamStudentData: StudentEnrollmentApprovalReject[] = [];
  public PreExamStudentAnnextureData: StudentEnrollmentApprovalReject[] = [];
  ...
  requestStudent = new StudentEnrollmentApprovalReject();
  ...
  constructor(private commonMasterService: CommonFunctionService,
    private studentEnrollmentApprovalRejectService: StudentEnrollmentApprovalRejectService,
  ...
  async ngOnInit() {
    ...
    await this.commonMasterService.ExamStudentStatusApprovalReject(this.sSOLoginDataModel.RoleID, 1)
      .then((data: any) => {
    ...
    this.request.StudentFilterStatusId = 15;
    if (this.request.StudentFilterStatusId == enumExamStudentStatus.RejectatBTER) {
      await this.GetStudentEnrollmentApprovalReject();
    }
  ...
  //get student data
  async GetStudentEnrollmentApprovalReject() {
    ...
    try {
      ...
      await this.studentEnrollmentApprovalRejectService.GetStudentEnrollmentApprovalReject(this.request)
        .then(async (data: any) => {
          data = JSON.parse(JSON.stringify(data));
  ...
  async ViewStudentDetails(content: any, StudentID: number) {
    
    await this.GetStudentProfileDetails(StudentID);
    const getGat = JSON.stringify(this.StudentProfileDetailsData); 
    console.log('test getdata for popup' + getGat);
  ...
  CloseViewStudentDetails() {
    ...
    this.requestStudent = new StudentEnrollmentApprovalReject()
    this.SubjectID = []
  ...
  async GetStudentProfileDetails(StudentID: number) {
    try {
      this.loaderService.requestStarted();
      //model
  ...
  async SaveData_EditStudentDetails() {
    ...
    this.loaderService.requestStarted();
    try {
      await this.studentEnrollmentApprovalRejectService.EditStudentData_PreExam(this.requestStudent)
        .then(async (data: any) => {
  ...
  async SaveData_PreExam_UpdateEnrollmentNo() {
    ...
    this.loaderService.requestStarted();
    try {
      await this.studentEnrollmentApprovalRejectService.SaveData_PreExam_UpdateEnrollmentNo(this.requestUpdateEnrollmentNo)
        .then(async (data: any) => {
          this.State = data['State'];
          this.Message = data['Message'];
          this.ErrorMessage = data['ErrorMessage'];
  ...
  async SaveDataMarked() {
    ...
    //// all steps
    //try {
    //  // reject at BTER ApprovalReject (at any level)

    //  if (this.status == enumExamStudentStatus.ApprovalReject) {
    //    if (this.request.StudentFilterStatusId != enumExamStudentStatus.ApprovalReject && this.sSOLoginDataModel.RoleID == EnumRole.Admin) {
    //      await this.SaveRejectAtBTERApprovalReject();
    //    }
    //    else {
    ...
    this.Swal2.Confirmation("Are you sure to continue?", async (result: any) => {
      ...
      if (result.isConfirmed) {
        try {
          ...
          // Call service to save student exam status
          await this.studentEnrollmentApprovalRejectService.SaveEligibleForEnrollment(request)
            .then(async (data: any) => {
              this.State = data['State'];
              this.Message = data['Message'];
              this.ErrorMessage = data['ErrorMessage'];
    ...
    this.Swal2.Confirmation("Are you sure to continue?", async (result: any) => {
      ...
      if (result.isConfirmed) {
        try {
          ...
          // Call service to save student exam status
          await this.studentEnrollmentApprovalRejectService.SaveRejectAtBTER(request)
            .then(async (data: any) => {
              this.State = data['State'];
              this.Message = data['Message'];
              this.ErrorMessage = data['ErrorMessage'];
  ...
  async GetPreExamStudentAnnexture() {
    try {
      ...
      this.loaderService.requestStarted();
      console.log(this.request);
      await this.studentEnrollmentApprovalRejectService.GetAnnextureListPreExamStudent(this.request)
        .then(async (data: any) => {
          data = JSON.parse(JSON.stringify(data));
          //success
          if (data.State == EnumStatus.Success) {
  ...
  async SaveRejectAtBTERApprovalReject() {
    ...
    this.Swal2.Confirmation("Are you sure to continue?", async (result: any) => {
      ...
      if (result.isConfirmed) {
        try {
          ...
          // Call service to save student exam status
          await this.studentEnrollmentApprovalRejectService.SaveRejectAtBTERApprovalReject(request)
            .then(async (data: any) => {
              this.State = data['State'];
              this.Message = data['Message'];
              this.ErrorMessage = data['ErrorMessage'];
