...
@Component({
  selector: 'app-bter-institute-student-reports',
  templateUrl: './bter-institute-student-reports.component.html',
  styleUrls: ['./bter-institute-student-reports.component.css'],
    standalone: false
})
export class InstituteStudentReportsComponent implements OnInit {
