...
@Component({
  selector: 'app-download-student-enrollment-details',
  standalone: false,
  templateUrl: './download-student-enrollment-details.component.html',
  styleUrl: './download-student-enrollment-details.component.css'
})
export class DownloadStudentEnrollmentDetailsComponent {
  ExamReportList: any[] = [];
  ...
  async GetAllData(): Promise<void> {
    const requestData = {
      ...
      ApplicationNo: this.filterForm.value.ApplicationNo,
      EnrollmentNo: this.filterForm.value.EnrollmentNo,
      MobileNo: this.filterForm.value.MobileNo,
    ...
    try {
      ...
      const response = await this.reportService.DownloadStudentEnrollmentDetails(requestData);
