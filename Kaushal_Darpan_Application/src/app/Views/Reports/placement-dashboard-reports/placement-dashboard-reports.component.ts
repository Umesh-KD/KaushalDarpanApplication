...
@Component({
  selector: 'app-placement-dashboard-reports',
  templateUrl: './placement-dashboard-reports.component.html',
  styleUrls: ['./placement-dashboard-reports.component.css'],
  standalone: false
})
export class PlacementDashReportComponent implements OnInit {
  ...
  filteredData: any[] = [];
  displayedColumns: string[] = ['SrNo', 'PostNo', 'PostSSOID', 'HR_Name', 'HR_Email', 'HR_MobileNo', 'CompanyName', 'CampusVenue', 'CampusVenueLocation','CreatedDate'];
