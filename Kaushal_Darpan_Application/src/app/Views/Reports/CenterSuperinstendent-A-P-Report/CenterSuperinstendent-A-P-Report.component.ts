...
import { SearchCenterSuperintendentAttendance } from '../../../Models/TheoryMarksDataModels';

@Component({
  selector: 'app-CenterSuperinstendent-A-P-Report',
  templateUrl: './CenterSuperinstendent-A-P-Report.component.html',
  styleUrl: './CenterSuperinstendent-A-P-Report.component.css',
  standalone: false
})
export class CenterSuperinstendentAPReportComponent {
  public searchRequest = new SearchCenterSuperintendentAttendance();
  _EnumRole = EnumRole
  ...
  async ngOnInit() {
    ...
    await this.GetCenterSuperinstendentAttendanceReport();
  }

  async GetMasterData() {
    try {
      this.loaderService.requestStarted();
      await this.commonMasterService.StreamMaster(this.sSOLoginDataModel.DepartmentID, 2)
        .then((data: any) => {
  ...
  async GetCenterSuperinstendentAttendanceReport() {
    try {
      //session
      ...
      this.loaderService.requestStarted();
      await this.reportService.GetCenterSuperintendentAttendanceReport(this.searchRequest)
        .then((data: any) => {
          data = JSON.parse(JSON.stringify(data));
  ...
  ResetControl() {
    this.searchRequest = new SearchCenterSuperintendentAttendance();
    this.GetCenterSuperinstendentAttendanceReport();
  }
  ...
  exportToExcel(): void {
    ...
    const unwantedColumns = [
      'SemesterId', 'CenterAssignedID', 'StreamID','InstituteID'
    ];
    ...
    XLSX.writeFile(wb, 'CenterSuperinstendentAbsentOrPresentReport.xlsx');
  }
