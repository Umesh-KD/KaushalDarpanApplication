...
@Component({
  selector: 'app-bter-mass-copping-reports',
  templateUrl: './bter-mass-copping-reports.component.html',
  styleUrls: ['./bter-mass-copping-reports.component.css'],
    standalone: false
})
export class MassCoppingReportsComponent implements OnInit {
  ...
  exportToExcel(): void {
    ...
    XLSX.writeFile(wb, 'MassCoppingReports.xlsx');
  }
  ...
  async GetAllData() {
    ...
    try {
      ...
      await this.reportService.GetBterMassCopingReport(requestData)
        .then((data: any) => {
