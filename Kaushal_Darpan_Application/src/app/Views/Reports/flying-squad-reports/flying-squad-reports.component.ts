...
@Component({
  selector: 'app-flying-squad-reports',
  templateUrl: './flying-squad-reports.component.html',
  styleUrls: ['./flying-squad-reports.component.css'],
  standalone: false
})
export class FlyingSquadReportsComponent implements OnInit {
  ...
  displayedColumns: string[] = [
    'SrNo', 'TeamName', 'CenterName', 'DeploymentDate', 'ExamShift', 'SSOID', 'Name', 'CourseTypeName'
  ];
  ...
  EnumDeploymentStatus = EnumDeploymentStatus;
  ...
  async GetAllData() {
    ...
    try {
      ...
      await this.reportService.GetFlyingSquadReports(requestData)
        .then((data: any) => {
