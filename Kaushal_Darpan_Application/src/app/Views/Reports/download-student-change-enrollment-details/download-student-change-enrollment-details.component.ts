...
@Component({
  selector: 'app-download-student-change-enrollment-details',
  standalone: false,
  templateUrl: './download-student-change-enrollment-details.component.html',
  styleUrl: './download-student-change-enrollment-details.component.css'
})
export class DownloadStudentChangeEnrollmentDetailsComponent {
  ExamReportList: any[] = [];
  ...
  async GetAllData(): Promise<void> {
    const requestData = {
      ...
      OldEnrollmentNo: this.filterForm.value.OldEnrollmentNo,
      EnrollmentNo: this.filterForm.value.EnrollmentNo,
      InstituteCode: this.filterForm.value.InstituteCode || 0,
      InstituteID: this.filterForm.value.InstituteID || 0,
    ...
    try {
      ...
      const response = await this.reportService.DownloadStudentChangeEnrollmentDetails(requestData);
