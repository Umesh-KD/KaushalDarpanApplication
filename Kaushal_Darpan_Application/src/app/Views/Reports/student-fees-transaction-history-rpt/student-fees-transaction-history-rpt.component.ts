...
import { GetApplicationFeesTransactionSearchModel, StudentFeesTransactionHistoryRptModel, StudentFeesTransactionHistorySearchmodel } from '../../../Models/StudentFeesTransactionHistoryRptBasedDataModel';
...
@Component({
    selector: 'app-student-fees-transaction-history-rpt',
    templateUrl: './student-fees-transaction-history-rpt.component.html',
    styleUrls: ['./student-fees-transaction-history-rpt.component.css'],
    standalone: false
})
export class StudentFeesTransactionHistoryRptComponent {
  ...
  public EmitraServiceDetails: any = []
  ...
  async GetMasterDDL() {
    try {
      this.loaderService.requestStarted();
      await this.commonMasterService.GetCommonMasterData('EmitraServiceDetails', this.sSOLoginDataModel.DepartmentID, this.sSOLoginDataModel.Eng_NonEng)
        .then((data: any) => {
          data = JSON.parse(JSON.stringify(data));
          this.EmitraServiceDetails = data['Data'];
  ...
  async resetControl() {
    this.searchRequest = new StudentFeesTransactionHistorySearchmodel();
    this.searchRequest.DepartmentID = EnumDepartment.BTER;
    this.searchRequest.AcademicYearID = this.sSOLoginDataModel.FinancialYearID;
