...
@Component({
  selector: 'app-bter-attendacne-dashboard',
    templateUrl: './bter-attendacne-dashboard.component.html',
    styleUrls: ['./bter-attendacne-dashboard.component.css'],
    standalone: false
})
export class BterAttendanceDashboardComponent implements OnInit {
