...
@Component({
  selector: 'app-DispatchSuperintendentList',
  templateUrl: './DispatchSuperintendentList.component.html',
  styleUrls: ['./DispatchSuperintendentList.component.css'],
  standalone: false
})
export class DispatchSuperintendentListComponent implements OnInit {
