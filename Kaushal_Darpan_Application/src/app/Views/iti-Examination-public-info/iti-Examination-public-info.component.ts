...
@Component({
  selector: 'app-iti-Examination-public-info',
  templateUrl: './iti-Examination-public-info.component.html',
  styleUrl: './iti-Examination-public-info.component.css',
  standalone: false
})
export class ITIExaminationPublicInfoComponent {
