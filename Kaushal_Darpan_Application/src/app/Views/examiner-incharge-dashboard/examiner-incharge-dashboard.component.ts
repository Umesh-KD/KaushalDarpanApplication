...
@Component({
  selector: 'app-examiner-incharge-dashboard',
  templateUrl: './examiner-incharge-dashboard.component.html',
  styleUrl: './examiner-incharge-dashboard.component.css',
  standalone: false
})
export class ExaminerInchargeComponent
{
  ...
  async GetAllData()
  {
    ...
    try {
      ...
      await this.examinerService.ExaminerInchargeDashboard(this.examinerDashboardSearchModelReq)
        .then((data: any) => {
