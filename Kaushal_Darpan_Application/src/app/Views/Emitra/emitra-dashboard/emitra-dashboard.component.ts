  ...
  LoadTabs()
  {
    this.tabs =
     ...
     // { TabName: 'FILL Fee using challan', TabNameHI: 'चालान के माध्यम से शुल्क भरें', TabIcon: 'ti ti-exchange', component: FeePaidByChallanComponent, ServiceID: EnumEmitraService.BTER_DegreeNonENG_AppplicationFeeService, DepartmentID: 1 },
      ...
      { TabName: 'Student Enrollment fee (engineering)', TabNameHI: 'छात्र नामांकन शुल्क (इंजीनियरिंग)', TabIcon: 'ti ti-exchange', component: StudentEmitraFeePaymentComponent, ServiceID: EnumEmitraService.BTER_EnrollmentFees_ENG, DepartmentID: 1 },
      { TabName: 'Student Enrollment fee (non. engineering)', TabNameHI: 'छात्र नामांकन शुल्क (गैर इंजीनियरिंग)', TabIcon: 'ti ti-exchange', component: StudentEmitraFeePaymentComponent, ServiceID: EnumEmitraService.BTER_EnrollmentFees_NonENG, DepartmentID: 1 },
