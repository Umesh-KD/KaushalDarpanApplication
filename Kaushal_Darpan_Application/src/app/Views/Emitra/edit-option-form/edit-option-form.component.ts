...
export class EditOptionFormComponent {
  ...
  async GetStudentApplication() {
    ...
    try {
      ...
      await this.studentService.GetStudentApplication(this.searchRequest)
        .then((data: any) => {
          data = JSON.parse(JSON.stringify(data));
      ...
      await this.sSOLoginService.MobileLogin(MobileNo, CourseTypeId)
        .then(async (data: any) => {
          ...
          if (this.State == EnumStatus.Success) {
            ...
            this.sSOLoginDataModel.ApplicationID = ApplicationID;
  ...
  async SSOLogin() {
    ...
    if (this.sSOLoginDataModel.RoleID == 4) {
      ...
      this.sSOLoginDataModel.DepartmentID = 1;
      this.sSOLoginDataModel.ApplicationID = 0;
        ...
        await this.sSOLoginService.MobileLogin(this.sSOLoginDataModel.SSOID, this.CourseTypeId)
          .then(async (data: any) => {
            ...
            if (this.State == EnumStatus.Success) {
              ...
              this.sSOLoginDataModel.DepartmentID = 1;
              this.sSOLoginDataModel.ApplicationID = data['Data'].ApplicationID;
