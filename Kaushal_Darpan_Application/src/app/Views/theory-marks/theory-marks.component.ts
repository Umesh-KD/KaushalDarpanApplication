...
@Component({
  selector: 'app-theory-marks',
  templateUrl: './theory-marks.component.html',
  styleUrls: ['./theory-marks.component.css'],
  standalone: false
})
export class TheoryMarksComponent implements OnInit {
    ...
    this.Swal2.Confirmation("Are you sure? <br> Once Submitted, It can't be edited anymore.",
      async (result: any) => {
        if (result.isConfirmed) {
          ...
          this.OpenModalFeedbackPopup(this.MyModel_FeedbackForm);
  ...
  OpenModalFeedbackPopup(content: any) {
