...
import { DropdownValidators } from '../../../Services/CustomValidators/custom-validators.service';
 ...
 @Component({
    selector: 'app-pay-exam-fee',
    standalone: false,
    templateUrl: './pay-exam-fee.component.html',
    styleUrl: './pay-exam-fee.component.css'
  })
export class PayExamFeeComponent implements OnInit {
 ...
 this.searchRequest = new StudentSearchModel();
  ...
  async GetAllDataActionWise() {
    ...
    this.searchRequest.action = "_PendingStudentExamFee";
