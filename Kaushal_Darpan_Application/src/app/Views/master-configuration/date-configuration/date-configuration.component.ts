...
@Component({
  selector: 'app-date-configuration',
  templateUrl: './date-configuration.component.html',
  styleUrls: ['./date-configuration.component.css'],
  standalone: false
})
export class DateConfigurationComponent implements OnInit, OnDestroy {
