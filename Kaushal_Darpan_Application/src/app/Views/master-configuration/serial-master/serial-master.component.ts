...
@Component({
  selector: 'app-serial-master',
  templateUrl: './serial-master.component.html',
  styleUrls: ['./serial-master.component.css'],
  standalone: false
})
export class SerialMasterComponent implements OnInit {
