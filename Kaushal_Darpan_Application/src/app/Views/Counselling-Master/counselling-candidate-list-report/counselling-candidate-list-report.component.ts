...
@Component({
  selector: 'app-counselling-candidate-list-report',
  standalone: false,
  templateUrl: './counselling-candidate-list-report.component.html',
  styleUrl: './counselling-candidate-list-report.component.css'
})
export class CounsellingCandidateListReportComponent {
       //designations = GlobalConstants.designationList; // Access the designations constant

  sSOLoginDataModel = new SSOLoginDataModel();
  request = new CounsellingReportListSearchModel();
  ...
  async ngOnInit() {
    ...
    console.log('Designation ID:', designationId);
      this.request.DesignationId=designationId;
    try {
  ...
  async GetAllottedCandidateList_Counselling() {
    try {
      ...
      await this.counsellingMasterService.GetCounselling_GetCandidateDetailsRPT(this.request)
        .then(async (data: any) => {
          data = JSON.parse(JSON.stringify(data));
