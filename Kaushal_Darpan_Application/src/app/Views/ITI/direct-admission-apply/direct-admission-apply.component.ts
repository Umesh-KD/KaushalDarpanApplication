...
@Component({
  selector: 'app-direct-admission-apply',
  standalone: false,
  templateUrl: './direct-admission-apply.component.html',
  styleUrl: './direct-admission-apply.component.css'
})
  export class DirectAdmissionApplyComponent {
