...
import { ItiInstructorComponent } from '../ITI_Instructor/iti-instructor/iti-instructor.component';
import { ItiInstructorFormComponent } from '../ITI_Instructor/iti-instructor-form/iti-instructor-form.component';
import { InstructorStatusListComponent } from '../instructor-status-list/instructor-status-list.component';
...
@Component({
  ...
  styleUrl: './instructor-tab.component.css'
})
export class InstructorTabComponent {
  ...
  async LoadTabs() {
    ...
    this.tabs.push({ TabName: 'Apply For ITI Instructor', TabNameHI: 'आईटीआई प्रशिक्षक के लिए आवेदन करें', TabIcon: 'ti ti-license', component: ItiInstructorFormComponent, DepartmentID: 2, CourseTypeId: 1, Enable: false, HasLink: false },
      { TabName: 'Check Application Status', TabNameHI: 'आवेदन की स्थिति जांचें', TabIcon: 'ti ti-license', component: InstructorStatusListComponent, DepartmentID: 2, CourseTypeId: 1, Enable: false, HasLink: false }
    );
