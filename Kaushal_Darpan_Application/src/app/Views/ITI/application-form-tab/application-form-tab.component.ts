...
@Component({
    selector: 'app-application-form-tab',
    templateUrl: './application-form-tab.component.html',
    styleUrls: ['./application-form-tab.component.css'],
    standalone: false
})
export class ApplicationFormTabComponent implements OnInit {
  ...
  tabs =
    [
      { TabName: 'Personal Details', TabNameHI: 'व्यक्तिगत विवरण', component: PersonalDetailsTabComponent, TabIcon: 'ti ti-user' },
