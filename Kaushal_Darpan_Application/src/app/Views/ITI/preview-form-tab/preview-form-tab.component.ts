...
@Component({
    selector: 'app-preview-form-tab',
    templateUrl: './preview-form-tab.component.html',
    styleUrls: ['./preview-form-tab.component.css'],
    standalone: false
})
export class PreviewFormTabComponent implements OnInit {
      ...
      await this.ItiApplicationFormService.GetApplicationPreviewbyID(this.searchrequest)
        .then((data: any) => {
          ...
          if (data['Data'] != null) {
            ...
            this.request.EmitraTransactionsDataModelList = data['Data']['EmitraTransactionsDataModelList']
