...
@Component({
  selector: 'app-verify-iti-flying-squad-deployment',
  standalone: false,
  templateUrl: './verify-iti-flying-squad-deployment.component.html',
  styleUrl: './verify-iti-flying-squad-deployment.component.css'
})
 ...
 ResetControl() {
  ...
  async GetAllDataForVerify() {
    try {
      ...
      await this.ITIFlyingSquadService.GetAllDataForVerify(this.searchRequest)
        .then((data: any) => {
          data = JSON.parse(JSON.stringify(data));
  ...
  //     this.searchRequest.EndTermID = this.sSOLoginDataModel.EndTermID
  //     this.searchRequest.Eng_NonEng = this.sSOLoginDataModel.Eng_NonEng
  //     await this.ITIFlyingSquadService.GetAllDataForGenerateOrder(this.searchRequest)
  //       .then((data: any) => {
  //         data = JSON.parse(JSON.stringify(data));
  //         this.CenterObserverData = data['Data'];
  //         this.loadInTable()
  ...
  async VerifyDeployment() {
    ...
    try {
      this.loaderService.requestStarted();
      await this.ITIFlyingSquadService.SaveDeploymentVerifiedData(Selected).then((data: any) => {
        data = JSON.parse(JSON.stringify(data));
        if (data.State == EnumStatus.Success) {
  ...
  async GenerateOrder() {
    ...
    try {
      debugger;
      this.loaderService.requestStarted();
      await this.ITIFlyingSquadService.GenerateFlyingSquadDutyOrder(Selected).then((data: any) => {
        data = JSON.parse(JSON.stringify(data));
        if (data.State == EnumStatus.Success) {
