...
@Component({
    selector: 'app-option-form-tab',
    templateUrl: './option-form-tab.component.html',
    styleUrls: ['./option-form-tab.component.css'],
    standalone: false
})
export class OptionFormTabComponent implements OnInit {
