...
@Component({
  selector: 'app-invigilator-attandance-report',
  standalone: false,
  templateUrl: './invigilator-attandance-report.component.html',
  styleUrl: './invigilator-attandance-report.component.css'
})
export class InvigilatorAttandanceReportComponent {
  public searchRequest = new ITIPaperUploadSearchModel();
  _EnumRole = EnumRole
  ...
  async GetTheoryMarksDetailList() {
    try {
      ...
      await this.TheoryMarksService.GetInviglatorAttandanceRptData(this.searchRequest)
        .then((data: any) => {
  ...
  exportToExcel(): void {
    ...
    const fileName = `attendance-Report-Data_${dateTime}.xlsx`;
