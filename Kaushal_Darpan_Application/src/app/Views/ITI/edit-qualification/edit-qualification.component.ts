...
import { HighestQualificationDetailsDataModel, OptionsDetailsDataModel, Qualification10thDetailsDataModel, Qualification12thDetailsDataModel, Qualification8thDetailsDataModel, QualificationDetailsDataModel }
  from '../../../Models/ITIFormDataModel';
...
export class EditQualificationComponent {
  ...
  async SaveQualification() {
    ...
    if (this.box8Checked) {
      if (this.formData8th.FileName == '') {
        this.toastr.warning("Please Upload Scanned copy of 8th Marksheet")
        return
      }
      this.request.push({
        ...
        DeleteStatus: 0,
        UniversityBoard: '',
        FileName: this.formData8th.FileName,
        DisFileName: this.formData8th.DisFileName
      });
    }

    if (this.box10Checked) {
      if (this.formData10th.FileName == '') {
        this.toastr.warning("Please Upload Scanned copy of 10th Marksheet")
        return
      }
      this.request.push({
        ApplicationID: this.ApplicationID,
        ...
        DeleteStatus: 0,
        UniversityBoard: '',
        FileName: this.formData10th.FileName,
        DisFileName: this.formData10th.DisFileName
      });
    }

    if (this.box12Checked) {
      if (this.formData12th.FileName == '') {
        this.toastr.warning("Please Upload Scanned copy of 12th Marksheet")
        return
      }
      this.request.push({
        ApplicationID: this.ApplicationID,
        ...
        DeleteStatus: 0,
        UniversityBoard: '',
                FileName: this.formData12th.FileName,
        DisFileName: this.formData12th.DisFileName
      });
    }
    ...
    try {
      ...
      await this.ItiApplicationFormService.SaveEditQualificationDetailsData(this.request)
        .then((data: any) => {
          data = JSON.parse(JSON.stringify(data));
  ...
  async GetById() {
    ...
    try {
      this.loaderService.requestStarted();
      await this.ItiApplicationFormService.GetEditQualificationDatabyID(this.searchRequest)
        .then(async (data: any) => {
          data = JSON.parse(JSON.stringify(data));
          ...
          this.QualificationDataList.map((list: any) => {
            ...
            if (list.Qualification === "8") {
              ...
              this.formData8th.FileName = list.Marksheet8
              this.formData8th.DisFileName = list.DisMarksheet8
              this.calculatePercentage8th()
            }
              ...
              this.formData10th.FileName = list.Marksheet10
              this.formData10th.DisFileName = list.DisMarksheet10
              this.calculatePercentage10th()
            }
              ...
              this.formData12th.FileName = list.Marksheet12
              this.formData12th.DisFileName = list.DisMarksheet12
  ...
  async UploadDocument(event: any, item: any,type:any) {
    try {
      //upload model
      let uploadModel = new UploadFileModel();
      uploadModel.FileExtention =  ".jpg,.jpeg,.png,.gif,.pdf";
      uploadModel.MinFileSize =  "20kb";
      uploadModel.MaxFileSize = "2mb";
      ...
      await this.documentDetailsService.UploadDocument(event, uploadModel)
        .then((data: any) => {
          ...
          if (data.State == EnumStatus.Success) {
            ...
            if (type == 8) {
              this.formData8th.FileName = data.Data[0].FileName;;
              this.formData8th.DisFileName = data.Data[0].Dis_FileName;;
            }


            if (type == 10) {
              this.formData10th.FileName = data.Data[0].FileName;;
              this.formData10th.DisFileName = data.Data[0].Dis_FileName;;
            }
            if (type == 12) {
              this.formData12th.FileName = data.Data[0].FileName;;
              this.formData12th.DisFileName = data.Data[0].Dis_FileName;;
            }
            //reset file type
  ...
  async DeleteDocument(item: any,type:any) {
    try {
      ...
      await this.documentDetailsService.DeleteDocument(deleteModel)
        .then((data: any) => {
          ...
          if (data.State != EnumStatus.Error) {
            ...
            if (type == 8) {
              this.formData8th.FileName = '';
              this.formData8th.DisFileName = '';
            }


            if (type == 10) {
              this.formData10th.FileName = '';
              this.formData10th.DisFileName = '';
            }
            if (type == 12) {
              this.formData12th.FileName = '';
              this.formData12th.DisFileName = '';
            }
