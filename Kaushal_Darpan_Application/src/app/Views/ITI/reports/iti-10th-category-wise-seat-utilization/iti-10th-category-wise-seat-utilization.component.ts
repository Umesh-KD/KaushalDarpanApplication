...
import { ITIAddmissionReportSearchModel } from '../../../../Models/TheoryMarksDataModels';
...
@Component({
  selector: 'app-iti-10th-category-wise-seat-utilization',
  standalone: false,
  templateUrl: './iti-10th-category-wise-seat-utilization.component.html',
  styleUrl: './iti-10th-category-wise-seat-utilization.component.css'
})
export class Iti10ThCategoryWiseSeatUtilizationComponent implements OnInit {
    
  public AddStaffBasicDetailFromGroup!: FormGroup;
  public searchRequest = new ITIAddmissionReportSearchModel();
  ...
  async BtnSearch() {
    ...
    if (this.searchRequest.DivisionID == 0 && this.searchRequest.DistrictID == 0) {
      this.toastr.error("Please select either Division or District.");
      return;
    }
    await this.GetList();
  }
  ...
  async GetList() {
    try {
      ...
      this.searchRequest.TradeLevelID = 10;
      this.loaderService.requestStarted();
     // this.searchRequest.EndTermID = this.sSOLoginDataModel.EndTermID;
      await this.ReportServices.GetITICategoryWiseSeatUtilizationDataList(this.searchRequest)
        .then((data: any) => {
          data = JSON.parse(JSON.stringify(data));
  ...
  exportToExcel(): void {
    ...
    XLSX.writeFile(wb, '10th-category-wise-seat-utilizationList.xlsx');
  }
