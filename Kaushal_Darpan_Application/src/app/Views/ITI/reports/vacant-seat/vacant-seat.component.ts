...
import { VacantSeatRequestModel } from '../../../../Models/TheoryMarksDataModels';
import * as XLSX from 'xlsx';

@Component({
  selector: 'app-vacant-seat',
  standalone: false,
  templateUrl: './vacant-seat.component.html',
  styleUrl: './vacant-seat.component.css'
})
export class VacantSeatComponent {
  public isFormSubmitted: boolean = false;
  public isLoading: boolean = false;
  public requestModel = new VacantSeatRequestModel();
  ...
  async ngOnInit() {
    ...
    await this.GetVacantSeatList();

  }

  async GetVacantSeatList() {
    this.requestModel = {
      AcademicYearID: this.sSOLoginDataModel.FinancialYearID,
      DistrictID: this.selectedDistrict,
      DivisionID: this.selectedDivision,
      ITICode: this.selectedITIGcode,
    ...
    try {
      ...
      await this.ReportService.getVacantSeatList(this.requestModel)
        .then((data: any) => {
  ...
  async SearchVacantSeatList() {
    ...
    this.GetVacantSeatList();
  }

  public Reset() {
    this.selectedDivision = 0;
    this.selectedDistrict = 0;
    this.selectedITIGcode = '';
    this.selectedCollegeId = 0;
    this.GetVacantSeatList();
  }

  VacantSeatExportToExcel() {
    ...
    const fileName = `VacantSeatList_${className}_Class.xlsx`;
