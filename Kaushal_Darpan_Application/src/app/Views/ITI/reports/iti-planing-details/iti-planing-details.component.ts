...
@Component({
  selector: 'app-iti-planing-details',
  standalone: false,
  templateUrl: './iti-planing-details.component.html',
  styleUrl: './iti-planing-details.component.css'
})
export class ItiPlaningDetailsComponent implements OnInit {
  ...
  async BtnSearch() {
    debugger
    if (this.searchRequest.ITICollegeID == 0 && this.searchRequest.StatusID ==0) {
  ...
  async GetList() {
    try {
     ...
     // this.searchRequest.EndTermID = this.sSOLoginDataModel.EndTermID;
      await this.ReportServices.GetITIPlaningDetailsDataList(this.searchRequest)
        .then((data: any) => {
          data = JSON.parse(JSON.stringify(data));
