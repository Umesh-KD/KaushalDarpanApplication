...
@Component({
  selector: 'app-iti-category-wise-seat-utilization',
  standalone: false,
  templateUrl: './iti-category-wise-seat-utilization.component.html',
  styleUrl: './iti-category-wise-seat-utilization.component.css'
})
export class ItiCategoryWiseSeatUtilizationComponent implements OnInit {
  ...
  async GetList() {
    try {
      ...
      this.searchRequest.TradeLevelID = 0;   // 8 or 10th level
      this.loaderService.requestStarted();
  ...
  exportToExcel(): void {
    ...
    XLSX.writeFile(wb, 'category-wise-seat-utilizationList.xlsx');
  }
