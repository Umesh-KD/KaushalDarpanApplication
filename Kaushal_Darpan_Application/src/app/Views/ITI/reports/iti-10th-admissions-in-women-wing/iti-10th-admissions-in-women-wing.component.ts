...
@Component({
  selector: 'app-iti-10th-admissions-in-women-wing',
  standalone: false,
  templateUrl: './iti-10th-admissions-in-women-wing.component.html',
  styleUrl: './iti-10th-admissions-in-women-wing.component.css'
})
export class Iti10ThAdmissionsInWomenWingComponent implements OnInit {
  ...
  exportToExcel(): void {
    ...
    XLSX.writeFile(wb, '10th-admissions-in-women-wing.xlsx');
  }
