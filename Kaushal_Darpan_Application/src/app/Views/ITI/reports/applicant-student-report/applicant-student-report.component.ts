...
import { VacantSeatRequestModel, AllotmentReportCollegeRequestModel, ApplicantReportForAdmin } from '../../../../Models/TheoryMarksDataModels';
...
@Component({
  selector: 'app-applicant-student-report',
  standalone: false,
  templateUrl: './applicant-student-report.component.html',
  styleUrl: './applicant-student-report.component.css'
})
export class ApplicantStudentReportComponent {
  public isFormSubmitted: boolean = false;
  public isLoading: boolean = false;
  public searchRequest = new ApplicantReportForAdmin();
  ...
  async GetAllotedSeatByCollegeList() {
    ...
    try {
      ...
      const response = await this.ReportService.GetApplicantReportForAdmin(this.searchRequest);
  ...
  AllotedSeatByCollegeExportToExcel() {
    ...
    const fileName = `Applicant_Data_${timestamp}.xlsx`;
