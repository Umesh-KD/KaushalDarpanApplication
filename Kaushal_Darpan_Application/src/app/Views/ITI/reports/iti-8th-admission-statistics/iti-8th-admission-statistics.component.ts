...
@Component({
  selector: 'app-iti-8th-admission-statistics',
  standalone: false,
  templateUrl: './iti-8th-admission-statistics.component.html',
  styleUrl: './iti-8th-admission-statistics.component.css'
})
export class Iti8ThAddmissionStatisticsComponent implements OnInit {
  ...
  exportToExcel(): void {
    ...
    XLSX.writeFile(wb, '8th-admission-statisticsList.xlsx');
  }
