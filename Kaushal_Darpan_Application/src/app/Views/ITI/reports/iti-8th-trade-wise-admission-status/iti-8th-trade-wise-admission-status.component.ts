...
@Component({
  selector: 'app-iti-8th-trade-wise-admission-status',
  standalone: false,
  templateUrl: './iti-8th-trade-wise-admission-status.component.html',
  styleUrl: './iti-8th-trade-wise-admission-status.component.css'
})
export class Iti8ThTradeWiseAdmissionStatusComponent implements OnInit {
  ...
  exportToExcel(): void {
    ...
    XLSX.writeFile(wb, '8th-trade-wise-admission-status.xlsx');
  }
