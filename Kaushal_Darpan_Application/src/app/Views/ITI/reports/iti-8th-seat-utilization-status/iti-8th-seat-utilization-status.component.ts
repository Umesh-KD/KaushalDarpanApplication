...
@Component({
  selector: 'app-iti-8th-seat-utilization-status',
  standalone: false,
  templateUrl: './iti-8th-seat-utilization-status.component.html',
  styleUrl: './iti-8th-seat-utilization-status.component.css'
})
export class Iti8ThSeatUtilizationStatusComponent implements OnInit {
  ...
  exportToExcel(): void {
    ...
    XLSX.writeFile(wb, '8th-seat-utilization-statusList.xlsx');
  }
