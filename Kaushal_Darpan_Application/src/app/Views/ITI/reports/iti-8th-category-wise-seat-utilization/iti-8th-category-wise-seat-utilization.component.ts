...
@Component({
  selector: 'app-iti-8th-category-wise-seat-utilization',
  standalone: false,
  templateUrl: './iti-8th-category-wise-seat-utilization.component.html',
  styleUrl: './iti-8th-category-wise-seat-utilization.component.css'
})
export class Iti8ThCategoryWiseSeatUtilizationComponent implements OnInit {
  ...
  exportToExcel(): void {
    ...
    XLSX.writeFile(wb, '8th-category-wise-seat-utilizationList.xlsx');
  }
