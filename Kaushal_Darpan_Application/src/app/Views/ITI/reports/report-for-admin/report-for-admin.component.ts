...
import { VacantSeatRequestModel, AllotmentReportCollegeRequestModel, ReportedStudentReport } from '../../../../Models/TheoryMarksDataModels';
...
@Component({
  ...
  standalone: false,
  templateUrl: './report-for-admin.component.html',
  styleUrl: './report-for-admin.component.css'
})
export class ReportedStudentReportComponent {
  public isFormSubmitted: boolean = false;
  public isLoading: boolean = false;
  public searchRequest = new ReportedStudentReport();
