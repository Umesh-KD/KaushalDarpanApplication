...
@Component({
  selector: 'app-iti-10th-seat-utilization-status',
  standalone: false,
  templateUrl: './iti-10th-seat-utilization-status.component.html',
  styleUrl: './iti-10th-seat-utilization-status.component.css'
})
export class Iti10ThSeatUtilizationStatusComponent implements OnInit {
  ...
  async GetList() {
    try {
     ...
     // this.searchRequest.EndTermID = this.sSOLoginDataModel.EndTermID;
      await this.ReportServices.GetITISeatUtilizationStatusDataList(this.searchRequest)
        .then((data: any) => {
          data = JSON.parse(JSON.stringify(data));
  ...
  exportToExcel(): void {
    ...
    XLSX.writeFile(wb, '10th-seat-utilization-statusList.xlsx');
  }
