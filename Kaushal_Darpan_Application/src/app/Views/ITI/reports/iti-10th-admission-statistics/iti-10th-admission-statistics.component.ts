...
@Component({
  selector: 'app-iti-10th-admission-statistics',
  standalone: false,
  templateUrl: './iti-10th-admission-statistics.component.html',
  styleUrl: './iti-10th-admission-statistics.component.css'
})
export class Iti10ThAddmissionStatisticsComponent implements OnInit {
  ...
  async GetList() {
    try {
     ...
     // this.searchRequest.EndTermID = this.sSOLoginDataModel.EndTermID;
      await this.ReportServices.GetITIAddmissionStatisticsDataList(this.searchRequest)
        .then((data: any) => {
          data = JSON.parse(JSON.stringify(data));
  ...
  exportToExcel(): void {
    ...
    XLSX.writeFile(wb, '10th-admission-statisticsList.xlsx');
  }
