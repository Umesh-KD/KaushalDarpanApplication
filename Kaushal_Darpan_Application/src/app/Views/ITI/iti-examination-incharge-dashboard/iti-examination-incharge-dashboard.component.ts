...
@Component({
  selector: 'app-iti-examination-incharge-dashboard',
  standalone:false,
  templateUrl: './iti-examination-incharge-dashboard.component.html',
  styleUrl: './iti-examination-incharge-dashboard.component.css'
})
export class ItiExaminationInchargeDashboardComponent implements OnInit{
