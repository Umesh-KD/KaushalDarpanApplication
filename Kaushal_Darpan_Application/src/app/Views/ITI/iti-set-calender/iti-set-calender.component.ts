...
@Component({
  selector: 'app-iti-set-calender',
  standalone: false,
  templateUrl: './iti-set-calender.component.html',
  styleUrl: './iti-set-calender.component.css'
})
export class ItiSetCalenderComponent {
  ...
  async getCalendarEventModel() {
    ...
    try {
      await this.attendanceServiceService.getCalendarEventModelITI(this.eventsSearch)
        .then((data: any) => {
  ...
  saveAllEvents() {
    try {
      ...
      this.attendanceServiceService.SetCalendarEventModelITI(formattedEvents)
        .then((data: any) => {
