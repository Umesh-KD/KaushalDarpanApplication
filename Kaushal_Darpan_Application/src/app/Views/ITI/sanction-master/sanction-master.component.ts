...
@Component({
  ...
  standalone: false,
  templateUrl: './sanction-master.component.html',
  styleUrl: './sanction-master.component.css'
})
export class SanctionMasterComponent {
  ...
  async GetRoleMasterList() {
    try {
      ...
      await this.HiringRoleMasterService.GetAllSanction()
        .then((data: any) => {
  ...
  async SaveData() {
    ...
    try {
      await this.HiringRoleMasterService.SaveDataSanction(this.request)
        .then((data: any) => {
          this.State = data['State'];
          this.Message = data['Message'];
          this.ErrorMessage = data['ErrorMessage'];
  ...
  async btnEdit_OnClick(ID: number) {
    ...
    try {
      this.loaderService.requestStarted();
      await this.HiringRoleMasterService.GetByIDSanction(ID)
        .then((data: any) => {
          data = JSON.parse(JSON.stringify(data));
          console.log(data);
