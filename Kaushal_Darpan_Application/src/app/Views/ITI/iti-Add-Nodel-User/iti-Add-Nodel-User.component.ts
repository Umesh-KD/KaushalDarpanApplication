...
import { ITIAdminNodelUserModel, ITIAdminUserDetailModel } from '../../../Models/ITI/ITIAdminUserDataModel';
...
@Component({
  ...
  standalone: false,
  templateUrl: './iti-Add-Nodel-User.component.html',
  styleUrl: './iti-Add-Nodel-User.component.css'
})
export class itiAddNodelUserComponent {
      ...
      await this.adminUserService.SaveNodalUserdata(this.adminRequest)
        .then((data: any) => {
          ...
          if (this.State == EnumStatus.Success) {
            ...
            this.ResetControls();
            this.routers.navigate(['/Nodal-User-List'])  
          }
          else {
