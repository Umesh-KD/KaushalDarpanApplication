...
@Component({
  ...
  templateUrl: './DepartmentWiseRequest-list.component.html',
  styleUrl: './DepartmentWiseRequest-list.component.css'
})
export class DepartmentWiseRequestlistComponent implements OnInit {
