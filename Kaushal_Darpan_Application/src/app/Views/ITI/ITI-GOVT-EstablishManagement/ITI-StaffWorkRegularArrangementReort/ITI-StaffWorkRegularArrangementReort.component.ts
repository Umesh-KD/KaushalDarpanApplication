...
import { ITI_EM_StaffListSearchModel, RequestUpdateStatus } from '../../../../Models/ITIGovtEMStaffMasterDataModel';
...
@Component({
  selector: 'app-ITI-StaffWorkRegularArrangementReort',
  standalone: false,
  templateUrl: './ITI-StaffWorkRegularArrangementReort.component.html',
  styleUrl: './ITI-StaffWorkRegularArrangementReort.component.css'
})
export class ITIStaffWorkRegularArrangementReortComponent {
  public searchRequest = new ITI_EM_StaffListSearchModel();
  ...
  async BTER_EM_GetStaffList() {
    ...
    try {
      this.loaderService.requestStarted();
      await this.itiGovtEMStaffMaster.GetStaffWorkRegular_ArrangementReort(this.searchRequest)
        .then((data: any) => {
          data = JSON.parse(JSON.stringify(data));
