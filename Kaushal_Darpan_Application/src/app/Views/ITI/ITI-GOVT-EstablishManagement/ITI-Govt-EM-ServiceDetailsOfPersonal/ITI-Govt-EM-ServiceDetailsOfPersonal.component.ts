...
import { ITIGovtEMStaff_ServiceDetailsOfPersonalModel, ITIGovtEMStaffMasterDataModel, ITI_Govt_EM_ZonalOFFICERSSearchDataModel, ITI_Govt_EM_ZonalOFFICERSDataModel, UpdateSSOIDByPricipleModel, ITI_Govt_EM_OFFICERSSearchDataModel, ITI_Govt_EM_OFFICERSDataModel, ITIGovtEMStaff_promotionModel, ITI_Govt_EM_PersonalDetailByUserIDSearchModel, RequestUpdateStatus, ITI_Govt_EM_ServiceDeleteModel } from '../../../../Models/ITIGovtEMStaffMasterDataModel';
...
@Component({
  selector: 'app-ITI-Govt-EM-ServiceDetailsOfPersonal',
  standalone: false,
  
  templateUrl: './ITI-Govt-EM-ServiceDetailsOfPersonal.component.html',
  styleUrl: './ITI-Govt-EM-ServiceDetailsOfPersonal.component.css'
})
export class ITIGovtEMServiceDetailsOfPersonalComponent implements OnInit {
  public AddStaffBasicDetailFromGroup!: FormGroup;
  public formData = new ITIGovtEMStaff_ServiceDetailsOfPersonalModel();
  public isSubmitted: boolean = false;

  public searchRequest = new ITI_Govt_EM_ZonalOFFICERSSearchDataModel();
  public deleteRequest = new ITI_Govt_EM_ServiceDeleteModel();
  ...
  public finalSubmitRequest = new RequestUpdateStatus();
  ...
  AddedServiceList: ITIGovtEMStaff_ServiceDetailsOfPersonalModel[] = [];
  public ProfileStatus: number = 0;
  public ProfileStatusID: number = 0;
  public _EnumProfileStatus = EnumProfileStatus;
  public serviceDetailsRequest = new ITI_Govt_EM_PersonalDetailByUserIDSearchModel();
  ...
  async AddEducation() {
    ...
    if (isDuplicate) {
      ...
      this.formData = new ITIGovtEMStaff_ServiceDetailsOfPersonalModel();
  ...
  async DeleteRow(item: ITIGovtEMStaff_ServiceDetailsOfPersonalModel) {
        ...
        if (result.isConfirmed) {
          ...
          if (item.ID > 0) {
            try {
              ...
              this.loaderService.requestStarted();
              /*     alert(isParent)*/
              await this.ITIGovtEMStaffMasterService.ITI_Govt_EM_ServiceDetailsOfPersonnelDeleteByID(this.deleteRequest)
                .then(async (data: any) => {
                  data = JSON.parse(JSON.stringify(data));
                  console.log(data)
  ...
  async GetServiceDetails() {
    ...
    try {
      ...
      await this.ITIGovtEMStaffMasterService.ITIGovtEM_ITI_Govt_Em_PersonalDetailByUserID(this.serviceDetailsRequest)
        .then((data: any) => {
          data = JSON.parse(JSON.stringify(data));
          console.log(data);      
  ...
  async SaveData() {
    ...
    try {
      ...
      await this.ITIGovtEMStaffMasterService.ITIGovtEM_Govt_StaffProfileStaffPosting(this.AddedServiceList).then((data: any) => {
        data = JSON.parse(JSON.stringify(data));
  ...
  async FinalSaveData() {
    ...
    try {
      ...
      await this.ITIGovtEMStaffMasterService.FinalSubmitUpdateStaffProfileStatus(this.finalSubmitRequest).then((data: any) => {
        data = JSON.parse(JSON.stringify(data));
        if (data.State == EnumStatus.Success) {
          this.toastr.success(data.Message);
          this.AddedServiceList = [];
