...
import { ITIGovtEMAddStaffBasicDetailDataModel, ITIGovtEMStaff_EduQualificationDetailsModel, ITIGovtEMStaffMasterDataModel, ITIGovtEMStaffMasterSearchModel, ITIGovtEMStaffSubjectList } from '../../../../Models/ITIGovtEMStaffMasterDataModel';
...
@Component({
  selector: 'app-ITI-Govt-Establish-Staff-Master',
  templateUrl: './ITI-Govt-Establish-Staff-Master.component.html',
  styleUrls: ['./ITI-Govt-Establish-Staff-Master.component.css'],
    standalone: false
})
export class ITIGovtEstablishStaffMasterComponent implements OnInit {

  public StaffMasterFormGroup!: FormGroup;
  public EduQualificationFormGroup!: FormGroup;
  public AddsubjectFormGroup!: FormGroup;
  EducationalQualificationFormData = new ITIGovtEMStaff_EduQualificationDetailsModel();
  ...
  public AddedChoices: ITIGovtEMStaffSubjectList[] = []
  ...
  public Addrequest = new ITIGovtEMStaffSubjectList() 
  ...
  constructor(
    private ITIGovtEM: ITIGovtEMStaffMaster,
 ...
 async OnFilterDesignation() {
  ...
  async GetByID(id: number) {
    ...
    try {
      ...
      await this.ITIGovtEM.GetByID(id, this.sSOLoginDataModel.DepartmentID)
        .then(async (data: any) => {
          data = JSON.parse(JSON.stringify(data));
...
/*          await this.ddlStream_Change();*/
  ...
  async SaveData() {
    ...
    try {
      ...
      await this.ITIGovtEM.SaveStaffDetails(this.staffDetailsFormData)
        .then((data: any) => {
  ...
  ResetControls() {
    ...
    this.staffDetailsFormData = new ITIGovtEMStaffMasterDataModel();
      ...
      async (result: any) => {
        ...
        if (result.isConfirmed) {
          try {
            this.loaderService.requestStarted();
            this.staffDetailsFormData.ModifyBy = this.sSOLoginDataModel.UserID
            await this.ITIGovtEM.ChangeWorkingInstitute(this.staffDetailsFormData).then((data: any) => {
              data = JSON.parse(JSON.stringify(data));
              console.log(data);
              if (data.State === EnumStatus.Success){
                this.toastr.success(data.Message);
  ...
  async GetCurrentWorkingInstitute_ByID() {
   try {
     ...
     this.loaderService.requestStarted();
     await this.ITIGovtEM.GetCurrentWorkingInstitute_ByID(this.searchRequest)
       .then((data: any) => {
         data = JSON.parse(JSON.stringify(data));
         console.log("data", data)
  ...
  async CheckOtpAfterSave() {
      ...
      await this.ITIGovtEM.LockandSubmit(this.staffDetailsFormData).then((data: any) => {
        data = JSON.parse(JSON.stringify(data));
        console.log(data);
        if (data.State === EnumStatus.Success) {
          this.toastr.success(data.Message);
