...
import { ITIGovtEMAddStaffBasicDetailDataModel, ITIGovtEMStaffMasterDataModel, ITI_Govt_EM_SanctionedPostBasedInstituteSearchDataModel, ITI_Govt_EM_ZonalOFFICERSDataModel, UpdateSSOIDByPricipleModel, ITI_Govt_EM_OFFICERSSearchDataModel, ITI_Govt_EM_OFFICERSDataModel } from '../../../../Models/ITIGovtEMStaffMasterDataModel';
...
@Component({
  selector: 'app-ITI-Govt-EM-SanctionedPostBasedInstituteList',
  standalone: false,
  
  templateUrl: './ITI-Govt-EM-SanctionedPostBasedInstituteList.component.html',
  styleUrl: './ITI-Govt-EM-SanctionedPostBasedInstituteList.component.css'
})
export class ITIGovtEMSanctionedPostBasedInstituteListComponent implements OnInit {
  public AddStaffBasicDetailFromGroup!: FormGroup;
  public formData = new ITI_Govt_EM_ZonalOFFICERSDataModel();
  public isSubmitted: boolean = false;

  public searchRequest = new ITI_Govt_EM_SanctionedPostBasedInstituteSearchDataModel();
  ...
  async GetSanctionedPostBasedInstituteList() {
    ...
    try {
      ...
      await this.ITIGovtEMStaffMasterService.ITIGovtEM_Govt_SanctionedPostInstitutePersonnelBudget_GetAllData(this.searchRequest)
        .then((data: any) => {
