...
@Component({
  selector: 'app-iti-center-observer-deployment',
  standalone: false,
  templateUrl: './iti-center-observer-deployment.component.html',
  styleUrl: './iti-center-observer-deployment.component.css'
})
...
checkValidDate(event: Event): void {
  ...
  async getMasterData() {
    try {
      ...
      await this.itiCenterObserverService.GetExamShift().then((data: any) => {
        data = JSON.parse(JSON.stringify(data));
  ...
  GetInstituteMaster_ByDistrictWise(ID: any) {
    ...
    this.requestCenter.EndTermID = this.sSOLoginDataModel.EndTermID;
     this.itiCenterObserverService.GetCenter_DistrictWise(this.requestCenter).then((data: any) => {
  ...
  async SaveData() {
    ...
    try {
      ...
      await this.itiCenterObserverService.SaveDeploymentData(this.AddedDeploymentList).then((data: any) => {
        data = JSON.parse(JSON.stringify(data));
  ...
  async GetDeploymentDetailsByID () {
    try {
      this.loaderService.requestStarted();
      await this.itiCenterObserverService.GetDeploymentDetailsByID(this.searchRequest).then((data: any) => {
        data = JSON.parse(JSON.stringify(data));
        if(data.State == EnumStatus.Success) {
  ...
  async GetTimeTableDates () {
    try {
      ...
      await this.itiCenterObserverService.GetTimeTableDates(this.searchRequest).then((data: any) => {
        ...
        this.ExamTimeTableDDL = data.Data;
        if(data.State == EnumStatus.Success) {
  ...
  async GetAllTimeTableData() {
    try {
      ...
      await this.itiCenterObserverService.GetAllTimeTableData(this.searchReqTT).then((data: any) => {
        data = JSON.parse(JSON.stringify(data));
        if(data.State == EnumStatus.Success) {
