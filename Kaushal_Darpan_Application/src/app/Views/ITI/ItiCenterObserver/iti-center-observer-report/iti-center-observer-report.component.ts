...
@Component({
  selector: 'app-iti-center-observer-report',
  standalone: false,
  templateUrl: './iti-center-observer-report.component.html',
  styleUrl: './iti-center-observer-report.component.css'
})
export class ITICenterObserverReportComponent {
  ...
  async GetAllData () {
    try {
      ...
      this.searchRequest.DepartmentID = this.sSOLoginDataModel.DepartmentID
      this.searchRequest.UserID = this.sSOLoginDataModel.UserID
      await this.itiCenterObserverService.GetAllInspectedData(this.searchRequest).then((data: any) => {
  ...
  async VerifyOTP(id: number) {
        ...
        try {
          ...
          try {
            await this.itiCenterObserverService.GenerateCOAnsweredReport(this.searchRequest).then((data: any) => {
