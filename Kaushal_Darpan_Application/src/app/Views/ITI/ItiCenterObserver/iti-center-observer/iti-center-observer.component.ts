...
@Component({
  selector: 'app-iti-center-observer',
  standalone: false,
  templateUrl: './iti-center-observer.component.html',
  styleUrl: './iti-center-observer.component.css'
})
export class ItiCenterObserverComponent {
  ...
  async DeployTeam() {
    try {
      ...
      this.loaderService.requestStarted();
      await this.itiCenterObserverService.DeployTeam(this.requestDeploy)
        .then((data: any) => {
          data = JSON.parse(JSON.stringify(data));
  ...
  async DownloadChecklist(TeamID: number, DeploymentID: number) {
    try {
      ...
      this.loaderService.requestStarted();
      await this.itiCenterObserverService.GenerateCOAnsweredReport(this.searchRequest)
        .then((data: any) => {
          data = JSON.parse(JSON.stringify(data));
  ...
  async GetAllData() {
    try {
      ...
      await this.itiCenterObserverService.GetAllData(this.searchRequest)
        .then((data: any) => {
          data = JSON.parse(JSON.stringify(data));
      ...
      async (result: any) => {
        if (result.isConfirmed) {
          try {
            ...
            await this.itiCenterObserverService.DeleteDataByID(this.requestObs)
              .then(async (data: any) => {
                data = JSON.parse(JSON.stringify(data));
                console.log(data);
  ...
  //          try {
  //            this.loaderService.requestStarted();
  //            await this.itiCenterObserverService.ForwardToVerify(Selected).then((data: any) => {
  //              data = JSON.parse(JSON.stringify(data));
  //              if (data.State == EnumStatus.Success) {
      ...
      async (result: any) => {
        if (result.isConfirmed) {
          try {
            ...
            // this.searchRequest.DeploymentID = DeploymentID
            this.loaderService.requestStarted();
            await this.itiCenterObserverService.RequestApprove(DeplomentId)
              .then((data: any) => {
                data = JSON.parse(JSON.stringify(data));
