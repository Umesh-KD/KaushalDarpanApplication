...
@Component({
  selector: 'app-iti-Practical-Examiner-Report',
  standalone: false,
  templateUrl: './iti-Practical-Examiner-Report.component.html',
  styleUrl: './iti-Practical-Examiner-Report.component.css'
})
export class itiPracticalExaminerReportComponent {
