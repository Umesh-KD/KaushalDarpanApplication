...
@Component({
  selector: 'app-iti-staff-dashboard',
  standalone: false,
  templateUrl: './iti-staff-dashboard.component.html',
  styleUrl: './iti-staff-dashboard.component.css'
})
export class ItiStaffDashboardComponent {
  ...
  async GetAllData() {
    ...
    try {
      ...
      await this.StaffDashService.GetItiStaffMaster(this.staffDashSearchReq)
        .then((data: any) => {
          data = JSON.parse(JSON.stringify(data));
