...
@Component({
  selector: 'app-iti-tradewiseresult',
  standalone: false,
  templateUrl: './iti-tradewiseresult.component.html',
  styleUrl: './iti-tradewiseresult.component.css'
})
export class ItiTradeWiseResultComponent implements OnInit {
  ...
  async GetList() {
    try {
      ...
      await this.ReportServices.GetITITradeWiseResultDataList(this.searchRequest)
        .then((data: any) => {
  ...
  async TradeWiseResultDownload() {
    ...
    try {
      ...
      this.searchRequest.TradeScheme = this.sSOLoginDataModel.Eng_NonEng;
      this.searchRequest.EndTermID = this.sSOLoginDataModel.EndTermID;
      await this.ReportServices.ITITradeWiseResult(this.searchRequest)
        .then((data: any) => {
          this.State = data['State'];
          this.Message = data['Message'];
          this.ErrorMessage = data['ErrorMessage'];
