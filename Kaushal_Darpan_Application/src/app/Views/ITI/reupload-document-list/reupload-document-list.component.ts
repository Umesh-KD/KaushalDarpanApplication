...
@Component({
  selector: 'app-reupload-document-list',
  standalone: false,
  templateUrl: './reupload-document-list.component.html',
  styleUrl: './reupload-document-list.component.css'
})
export class ReuploadDocumentListComponent {
  ...
  async ngOnInit() {
    ...
    this.searchRequest.TradeLevel=10
  ...
  async getStudentsJoiningStatusMarksList(i: any) {
    ...
    try {
      ...
      await this.StudentsJoiningStatusMarksService.GetAllReuploadDocumentList(this.searchRequest)
        .then((data: any) => {
      ...
      await this.StudentsJoiningStatusMarksService.GetAllData(_searchRequest)
        .then((data: any) => {
          ...
          if (this.searchRequest.TradeLevel == 10) {
            columns = ["SrNo", "ApplicationNo", "Name", "FatherName", "DOB", "Gender", "StudentCategory", "MobileNo", "AadharNo", "TradeCode", "TradeName", "AllotedCategory", "TradeSchemeName", "ClassPer", "TenthMathsPer", "TenthSciencePer", "MeritNo"];
          } else {
            columns = ["SrNo", "ApplicationNo", "Name", "FatherName", "DOB", "Gender", "StudentCategory", "MobileNo", "AadharNo", "TradeCode", "TradeName", "AllotedCategory", "TradeSchemeName", "ClassPer", "MeritNo"];
          }
  ...
  async openModalGenerateOTP(content: any, AllotmentId: number, JoinStatus: string) {
    ...
    //        return
    //      } else {
    //        this.router.navigate(['/ReuploadDocument'], {
