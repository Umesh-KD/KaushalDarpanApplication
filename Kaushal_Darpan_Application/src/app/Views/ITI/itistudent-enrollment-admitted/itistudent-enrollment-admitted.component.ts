...
@Component({
  ...
  templateUrl: './itistudent-enrollment-admitted.component.html',
  styleUrls: ['./itistudent-enrollment-admitted.component.css'],
  standalone: false
})
export class ITIStudentEnrollmentAdmittedComponent {
  ...
  constructor(private commonMasterService: CommonFunctionService,
    private itistudentEnrollmentService: ITIStudentEnrollmentService,
  ...
  async ngOnInit() {
    ...
    this.request.AdmittStatus = this.activatedRoute.snapshot.paramMap.get('id') || '-1';
    this.AdmittStatus = this.request.AdmittStatus
   ...
   // this.request.InstituteID = this.sSOLoginDataModel.InstituteID
    ...
    console.log(this.MapKeyEng)
    this.MapKeyEng=1;
    console.log("mapkkkk: ",this.MapKeyEng)
  }
  ...
  async GetMasterData() {
    try {
      ...
      await this.commonMasterService.GetManagType(2)
        .then((data: any) => {
          data = JSON.parse(JSON.stringify(data));
  ...
  async btn_SearchClick() {
    ...
    console.log(this.SearchStudentDataFormGroup.value);
  ...
  async GetPreExamStudent() {
    try {
      ...
      this.request.ApplicationNo=this.SearchStudentDataFormGroup.value.ApplicationNo;
      this.request.InstituteID = this.SearchStudentDataFormGroup.value.ddlInstituteID;
    
      this.request.Name = this.SearchStudentDataFormGroup.value.txtStudentName;
      this.request.ManagementTypeID = this.SearchStudentDataFormGroup.value.ddlManagementID;
      this.request.MobileNo = this.SearchStudentDataFormGroup.value.txtMobileNo;
      this.request.StreamID = this.SearchStudentDataFormGroup.value.ddlStreamID;
     
      //call
      this.loaderService.requestStarted();
      console.log(this.request);
      await this.itistudentEnrollmentService.GetStudentAdmitted(this.request)
        .then(async (data: any) => {
          data = JSON.parse(JSON.stringify(data));
          //success
  ...
  async btn_Clear() {
    ...
    // this.SearchStudentDataFormGroup.patchValue({ApplicationNo:''})
    // this.SearchStudentDataFormGroup.patchValue({ddlInstituteID:0})
    // this.SearchStudentDataFormGroup.patchValue({ddlStreamID: 0})
    // this.SearchStudentDataFormGroup.patchValue({ddlSemesterID: ''})
    // this.SearchStudentDataFormGroup.patchValue({ddlManagementID: 0})
    // this.SearchStudentDataFormGroup.patchValue({txtStudentName: ''})
    // this.SearchStudentDataFormGroup.patchValue({txtMobileNo: ''})
       this.SearchStudentDataFormGroup.patchValue({
    ApplicationNo: '',
    ddlInstituteID: '0',
    ddlStreamID: '0',
    ddlSemesterID: '0',
  ...
  //   this.loaderService.requestStarted();
  //   try {
  //     await this.itistudentEnrollmentService.EditStudentData_PreExam(this.requestStudent)
  //       .then(async (data: any) => {
  ...
  //   this.loaderService.requestStarted();
  //   try {
  //     await this.itistudentEnrollmentService.SaveData_PreExam_UpdateEnrollmentNo(this.requestUpdateEnrollmentNo)
  //       .then(async (data: any) => {
  //         this.State = data['State'];
  //         this.Message = data['Message'];
  //         this.ErrorMessage = data['ErrorMessage'];
        ...
        try {
          ...
          selectedStudents.forEach(x => {
            request.push({
              ...
              CollegeTradeId: x.CollegeTradeId,
              TradeId: x.TradeId,
          ...
          await this.itistudentEnrollmentService.SaveAdmittedFinalStudentData(request)
            .then(async (data: any) => {
              this.State = data['State'];
              this.Message = data['Message'];
              this.ErrorMessage = data['ErrorMessage'];
  ...
  //         });
  //         // Call service to save student exam status
  //         await this.itistudentEnrollmentService.SaveEligibleForEnrollment(request)
  //           .then(async (data: any) => {
  //             this.State = data['State'];
  //             this.Message = data['Message'];
  //             this.ErrorMessage = data['ErrorMessage'];
  ...
  //         });
  //         // Call service to save student exam status
  //         await this.itistudentEnrollmentService.SaveRejectAtBTER(request)
  //           .then(async (data: any) => {
  //             this.State = data['State'];
  //             this.Message = data['Message'];
  //             this.ErrorMessage = data['ErrorMessage'];
  ...
  //     this.loaderService.requestStarted();
  //     console.log(this.request);
  //     await this.itistudentEnrollmentService.GetAnnextureListPreExamStudent(this.request)
  //       .then(async (data: any) => {
  //         data = JSON.parse(JSON.stringify(data));
  //         //success
  //         if (data.State == EnumStatus.Success) {
