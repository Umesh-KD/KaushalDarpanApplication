...
import { ITIViewPlacedStudentService } from '../../../Services/ITI/ITIViewPlacedStudent/ITIView-placed-student.service';
// import { ITIViewPlacedStudentService } from '../../../Services/ITI/ITIViewPlacedStudent/';
...
export class ViewPlacedStudentComponent implements OnInit {
  ...
  constructor(private commonMasterService: CommonFunctionService, private ViewPlacedStudentService: ITIViewPlacedStudentService, private toastr: ToastrService, private loaderService: LoaderService, private activatedRoute: ActivatedRoute, private routers: Router, private modalService: NgbModal) {
