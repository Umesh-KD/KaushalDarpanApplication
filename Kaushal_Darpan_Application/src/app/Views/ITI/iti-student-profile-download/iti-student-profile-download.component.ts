...
@Component({
  selector: 'app-iti-student-profile-download',
  standalone: false,
  templateUrl: './iti-student-profile-download.component.html',
  styleUrl: './iti-student-profile-download.component.css'
})
export class ITIStudentProfileDownloadComponent implements AfterViewInit {
  ...
  async GetById(id:string) {
    ...
    try {
      await this.ApplicationService.GetITIStudentProfileDownload(this.searchrequest)
        .then((data: any) => {
          data = JSON.parse(JSON.stringify(data));
