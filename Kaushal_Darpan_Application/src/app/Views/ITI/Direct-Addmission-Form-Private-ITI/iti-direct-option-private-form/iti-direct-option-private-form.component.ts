...
@Component({
  selector: 'app-iti-direct-option-private-form',
  standalone: false,
  templateUrl: './iti-direct-option-private-form.component.html',
  styleUrl: './iti-direct-option-private-form.component.css'
})
export class ITIDirectOptionPrivateFormComponent {
