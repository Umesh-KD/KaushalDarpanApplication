...
@Component({
  selector: 'app-iti-direct-document-private-form',
  standalone: false,
  templateUrl: './iti-direct-document-private-form.component.html',
  styleUrl: './iti-direct-document-private-form.component.css'
})
export class ITIDirectDocumentPrivateFormComponent {
