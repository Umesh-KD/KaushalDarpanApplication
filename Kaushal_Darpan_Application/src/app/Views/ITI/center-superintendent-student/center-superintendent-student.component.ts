...
@Component({
  selector: 'app-center-superintendent-student',
  standalone: false,
  templateUrl: './center-superintendent-student.component.html',
  styleUrl: './center-superintendent-student.component.css'
})
export class CenterSuperintendentStudentComponent {
  ...
  async GetTheoryMarksDetailList() {
    try {
      ...
      await this.TheoryMarksService.GetCenterStudents(this.searchRequest)
        .then((data: any) => {
          data = JSON.parse(JSON.stringify(data));
