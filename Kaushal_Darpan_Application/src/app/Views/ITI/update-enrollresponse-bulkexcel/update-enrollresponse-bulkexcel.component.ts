...
@Component({
    selector: 'update-enrollresponse-bulkexcel',
    templateUrl: './update-enrollresponse-bulkexcel.component.html',
    styleUrls: ['./update-enrollresponse-bulkexcel.component.css'],
    standalone: false
})
export class UpdateEnrollResponseBulkExcelComponent implements OnInit {
