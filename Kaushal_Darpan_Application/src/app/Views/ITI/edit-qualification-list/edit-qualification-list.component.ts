...
@Component({
  selector: 'app-edit-qualification-list',
  standalone: false,
  templateUrl: './edit-qualification-list.component.html',
  styleUrl: './edit-qualification-list.component.css'
})
export class EditQualificationListComponent {
