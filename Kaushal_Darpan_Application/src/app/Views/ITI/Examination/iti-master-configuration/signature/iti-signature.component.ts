...
import { CommonSignatureModel, SerialMasterConfigurationModel } from '../../../../../Models/MasterConfigurationModel';
...
@Component({
  selector: 'app-iti-signature',
  templateUrl: './iti-signature.component.html',
  styleUrls: ['./iti-signature.component.css'],
  standalone: false
})
export class ITISignatureMasterComponent implements OnInit {
  public SerialMasterFromGroup!: FormGroup;

  public isFormSubmitted: boolean = false;
  public isLoading: boolean = false;
  public request = new CommonSignatureModel();
    ...
    if (this.OTP.length > 0) {
      if ((this.OTP == GlobalConstants.DefaultOTP) || (this.OTP == this.GeneratedOTP)) {
        ...
        try {
          ...
          await this.mstConfigService.CommonSignature(this.request)
            .then((data: any) => {
  ...
  async openModalGenerateOTP(content: any, item: CommonSignatureModel) {
    this.isFormSubmitted = true;
  ...
  async btnEdit_OnClick(Item: CommonSignatureModel) {
    this.isFormSubmitted = false;
