...
import { GlobalConstants, EnumConfigTypeTabs, EnumRole, EnumStatus } from '../../../../../Common/GlobalConstants';
...
@Component({
  selector: 'app-iti-date-configuration',
  templateUrl: './iti-date-configuration.component.html',
  styleUrls: ['./iti-date-configuration.component.css'],
  standalone: false
})
export class ITIDateConfigurationComponent implements OnInit, OnDestroy {
