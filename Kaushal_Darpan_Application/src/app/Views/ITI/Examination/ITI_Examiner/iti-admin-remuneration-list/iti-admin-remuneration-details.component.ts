...
@Component({
  selector: 'app-iti-admin-remuneration-details',
  templateUrl: './iti-admin-remuneration-details.component.html',
  styleUrl: './iti-admin-remuneration-details.component.css',
  standalone: false
})
