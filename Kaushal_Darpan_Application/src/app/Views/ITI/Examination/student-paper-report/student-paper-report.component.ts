...
@Component({
  selector: 'app-student-paper-report',
  standalone: false,
  templateUrl: './student-paper-report.component.html',
  styleUrl: './student-paper-report.component.css'
})
export class StudentPaperReportComponent {
  ...
  exportToExcel(): void {
    ...
    const wb: XLSX.WorkBook = XLSX.utils.book_new();
    XLSX.utils.book_append_sheet(wb, ws, 'Sheet1');
    XLSX.writeFile(wb, 'Student-All-Report-Data.xlsx');
  }
