...
@Component({
  selector: 'app-iti-inspection-members',
  standalone: false,
  templateUrl: './iti-inspection-members.component.html',
  styleUrl: './iti-inspection-members.component.css'
})
export class ITIInspectionMembersComponent {
