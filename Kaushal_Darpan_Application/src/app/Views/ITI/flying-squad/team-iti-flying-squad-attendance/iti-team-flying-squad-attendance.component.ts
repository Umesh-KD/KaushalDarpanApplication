...
@Component({
  selector: 'app-iti-team-flying-squad-attendance',
  standalone: false,
  templateUrl: './iti-team-flying-squad-attendance.component.html',
  styleUrls: ['./iti-team-flying-squad-attendance.component.css']
})
export class AddITITeamFlyingSquadAttendanceComponent implements OnInit {
