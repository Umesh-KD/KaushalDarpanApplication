...
@Component({
    selector: 'app-add-itis',
    templateUrl: './add-itis.component.html',
    styleUrls: ['./add-itis.component.css'],
    standalone: false
})
export class AddITIsComponent implements OnInit{
  groupForm!: FormGroup;
  ...
  async ngOnInit() {
    ...
    this.groupForm = this.fb.group({
      ...
      txtMobileNumber: ['', [Validators.required, Validators.pattern(/^\d{10}$/)]],
      txtPincode: [''],
      check8th: [false],
      check10th: [false],
      check12th: [false]
