...
@Component({
  selector: 'app-iti-change-shift',
  standalone: false,
  templateUrl: './iti-change-shift.component.html',
  styleUrl: './iti-change-shift.component.css'
})
export class ItiChangeShiftComponent {
  ...
  public searchRequestTrade = new ITICollegeTradeSearchModel();
...
/*    this.searchRequest.TradeLevel = parseInt(this.route.snapshot.paramMap.get('id'));*/
  ...
  async getITITrade() {
    ...
    try {
      this.searchRequestTrade.Action = "_ITITrade";
      this.searchRequestTrade.CollegeID = this.sSOLoginDataModel.InstituteID;
      this.searchRequestTrade.TradeLevelId = this.searchRequest.TradeLevel.toString()
      this.searchRequestTrade.FinancialYearID = this.sSOLoginDataModel.FinancialYearID
      this.loaderService.requestStarted();
      await this.ITICollegeTradeService.getITITrade(this.searchRequestTrade)
        .then((data: any) => {
  ...
  async getStudentsJoiningStatusMarksList(i: any) {
    ...
    try {
      ...
      await this.StudentsJoiningStatusMarksService.GetChangeShiftUnitData(this.searchRequest)
        .then((data: any) => {
          data = JSON.parse(JSON.stringify(data));
          this.State = data['State'];
          this.Message = data['Message'];
          this.ErrorMessage = data['ErrorMessage'];
          this.StudentsJoiningStatusMarksList = data['Data']['Table'];
