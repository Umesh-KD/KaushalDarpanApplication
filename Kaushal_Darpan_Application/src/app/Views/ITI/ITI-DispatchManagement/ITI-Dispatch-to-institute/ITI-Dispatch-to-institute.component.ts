...
import { ITIBundelDataModel, ITICheckDateDispatchSearchModel, ITIDispatchFormDataModel, ITIDispatchSearchModel, ITICompanyDispatchMasterSearchModel } from '../../../../Models/ITIDispatchFormDataModel';
import { FormBuilder, FormGroup, Validators } from '@angular/forms';
import { ITIDispatchGroupDataModel, ITIDispatchGroupSearchModel, ITIInstituteGroupDetail } from '../../../../Models/ITIDispatchGroupDataModel';
...
@Component({
  selector: 'app-ITI-Dispatch-to-institute',
  standalone: false,
  templateUrl: './ITI-Dispatch-to-institute.component.html',
  styleUrl: './ITI-Dispatch-to-institute.component.css'
})
export class ITIDispatchToInstituteComponent {
...
/*  public MasterDDLList:any[]=[]*/
  ...
  public Principledetail = new ITIInstituteGroupDetail()
  public request = new ITIDispatchGroupDataModel();
  public Searchrequest = new ITIDispatchGroupSearchModel();

  public SearchrequestDDl = new ITIDispatchSearchModel();
  public SearchCheck = new ITICheckDateDispatchSearchModel();
/*  public Searchrequest = new BundelDataModel();*/
  ...
  async GetCompanyNameDDL() {
    ...
    try {
      ...
      await this.commonMasterService.GetITIDDLCompanyName(this.sSOLoginDataModel.DepartmentID, this.sSOLoginDataModel.Eng_NonEng, this.sSOLoginDataModel.EndTermID)
        .then((data: any) => {
  ...
  async onInstituteChange() {
    this.request = new ITIDispatchGroupDataModel()
  ...
  async searchBundelDataByDate() {
    try {
      ...
      this.Principledetail = new ITIInstituteGroupDetail();
    ...
    try {
      ...
      await this.dispatchService.GetGroupdetailsId(this.DispatchID)
        ...
        .then((data: any) => {
          ...
          const dateFields: (keyof ITIDispatchGroupDataModel)[] = [
