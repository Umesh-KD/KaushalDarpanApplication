...
import { ITIDispatchFormDataModel, ITIBundelDataModel, ITIDispatchSearchModel, ITIDispatchReceivedModel, ITIDownloadDispatchReceivedSearchModel, ITIDispatchMasterStatusUpdate } from '../../../../Models/ITIDispatchFormDataModel';
import { DropdownValidators } from '../../../../Services/CustomValidators/custom-validators.service';
import { LoaderService } from '../../../../Services/Loader/loader.service';
import { CommonFunctionService } from '../../../../Services/CommonFunction/common-function.service';
import { ToastrService } from 'ngx-toastr';
import { EnumCourseType, EnumDepartment, EnumLateralCourse, EnumStatus,  GlobalConstants, EnumITIDispatchDDlValue } from '../../../../Common/GlobalConstants';
...
@Component({
  ...
  templateUrl: './ITI-DispatchSuperintendentDetailsList.component.html',
  styleUrls: ['./ITI-DispatchSuperintendentDetailsList.component.css'],
  standalone: false
})
export class ITIDispatchSuperintendentDetailsListComponent implements OnInit
{
  ...
  public DispatchMasterStatusUpdate: ITIDispatchMasterStatusUpdate[] = [];
  ...
  async CheckOtpAfterSave() {
    ...
    for (const item of selectedItems) {
      ...
      } as ITIDispatchMasterStatusUpdate);
    }
    ...
    try {
      ...
      await this.dispatchService.GetAllDataDispatchMaster(this.Searchrequest)
        .then((data: any) => {
          ...
          console.log('testing data for iti send admin bundles',this.DispatchMasterSendToBterFromCenterList)
        }, error => console.error(error));
    }
    catch (Ex) {
      console.log(Ex);
