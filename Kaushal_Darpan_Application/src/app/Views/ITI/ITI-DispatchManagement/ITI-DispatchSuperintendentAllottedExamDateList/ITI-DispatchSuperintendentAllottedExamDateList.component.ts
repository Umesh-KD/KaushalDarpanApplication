...
@Component({
  selector: 'app-ITI-DispatchSuperintendentAllottedExamDateList',
  templateUrl: './ITI-DispatchSuperintendentAllottedExamDateList.component.html',
  styleUrls: ['./ITI-DispatchSuperintendentAllottedExamDateList.component.css'],
  standalone: false
})
export class ITIDispatchSuperintendentAllottedExamDateListComponent implements OnInit {
