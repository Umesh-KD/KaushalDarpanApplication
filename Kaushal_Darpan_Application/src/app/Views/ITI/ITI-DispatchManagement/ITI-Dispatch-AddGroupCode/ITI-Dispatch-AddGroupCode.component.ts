...
@Component({
  selector: 'app-ITI-Dispatch-AddGroupCode',
  templateUrl: './ITI-Dispatch-AddGroupCode.component.html',
  styleUrls: ['./ITI-Dispatch-AddGroupCode.component.css'],
  standalone: false
})

export class ITIDispatchAddGroupCodeComponent {
  public Message: any = [];
