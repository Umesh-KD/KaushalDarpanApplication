...
@Component({
  selector: 'app-sr6-report-iti',
  standalone: false,
  templateUrl: './sr6-report-iti.component.html',
  styleUrl: './sr6-report-iti.component.css'
})
export class SR6ReportITIComponent {
  ...
  async GetAllData() {
    try {
     ...
     // this.Searchrequest.staffID = 1;
      ...
      await this.itiInventoryService.GetSR6ReportData_ITI_INV(this.Searchrequest)
        .then((data: any) => {
          if (data) {
  ...
  async DownloadSR6ReportData_pdf() {
    try {
      this.loaderService.requestStarted();
     ...
     // this.Searchrequest.staffID = 1;
      ...
      await this.itiInventoryService.DownloadSR6ReportData_pdf(this.Searchrequest)
        .then((data: any) => {
          if (data) {
