...
@Component({
  selector: 'app-iti-equipments-mapping-list',
  templateUrl: './iti-equipments-mapping-list.component.html',
  styleUrls: ['./iti-equipments-mapping-list.component.css'],
  standalone: false
})
export class ITITradeEquipmentsMappingListComponent {
  ...
  isInstituteDisabled: boolean = true;
  constructor(
  ...
  async btnDelete_OnClick(Id: number) {
    ...
    this.Swal2.Confirmation("Are you sure ?",
      async (result: any) => {
        //confirmed
