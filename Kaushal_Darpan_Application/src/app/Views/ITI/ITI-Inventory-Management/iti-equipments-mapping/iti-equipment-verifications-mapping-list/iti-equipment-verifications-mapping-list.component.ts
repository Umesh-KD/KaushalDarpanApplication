...
@Component({
  selector: 'app-iti-equipment-verifications-mapping-list',
  templateUrl: './iti-equipment-verifications-mapping-list.component.html',
  styleUrls: ['./iti-equipment-verifications-mapping-list.component.css'],
  standalone: false
})
export class ITIEquipmentVerificationsMappingList {
  ...
  async GetAllData() {
    try {
      ...
      await this.itiInventoryService.GetAllEquipmentsMapping(this.Searchrequest)
        .then((data: any) => {
      ...
      async (result: any) => {
        ...
        if (result.isConfirmed) {
          try {
            ...
            await this.itiInventoryService.DeleteEquipmentsMappingByID(Id, this.UserID)
              .then(async (data: any) => {
                data = JSON.parse(JSON.stringify(data));
                console.log(data);
  ...
  async SaveData_EquipmentVerifications() {
    ...
    this.loaderService.requestStarted();
    try {
      await this.itiInventoryService.HOD_EquipmentVerifications(this.requestAction.TE_MappingId, this.requestAction.CreatedBy, this.requestAction.ReturnStatus)
        .then(async (data: any) => {
          this.State = data['State'];
          this.Message = data['Message'];
          this.ErrorMessage = data['ErrorMessage'];
