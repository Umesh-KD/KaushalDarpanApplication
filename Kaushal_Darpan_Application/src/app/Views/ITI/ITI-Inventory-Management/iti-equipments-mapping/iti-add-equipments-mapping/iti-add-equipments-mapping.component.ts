...
@Component({
  selector: 'app-iti-add-equipments-mapping',
  templateUrl: './iti-add-equipments-mapping.component.html',
  styleUrls: ['./iti-add-equipments-mapping.component.css'],
  standalone: false
})
export class ITIAddEquipmentsMappingComponent {
  ...
  async saveData() {
    ...
    try {
      ...
      await this.itiInventoryService.SaveEquipmentsMapping(this.request)
        .then((data: any) => {
          ...
          if (this.State == EnumStatus.Success) {
            ...
            this.ResetControl();
            this.router.navigateByUrl("iti-equipments-mapping");
          }
  ...
  async ResetControl() {
    ...
    this.requestEquipments = new DTEEquipmentsDataModel();
