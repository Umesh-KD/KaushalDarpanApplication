...
@Component({
  selector: 'app-iti-auction-list',
  standalone: false,
  templateUrl: './iti-auction-list.component.html',
  styleUrl: './iti-auction-list.component.css'
})

export class ITIAuctionListComponent {
  ...
  async GetAllData() {
    try {
      ...
      await this.itiInventoryService.GetAllAuctionList(this.Searchrequest)
        .then((data: any) => {
          debugger;
          data = JSON.parse(JSON.stringify(data));
          this.State = data['State'];
