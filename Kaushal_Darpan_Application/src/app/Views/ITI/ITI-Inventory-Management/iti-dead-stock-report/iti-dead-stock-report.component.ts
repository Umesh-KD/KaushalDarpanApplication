...
@Component({
  selector: 'app-iti-dead-stock-report',
  templateUrl: './iti-dead-stock-report.component.html',
  styleUrls: ['./iti-dead-stock-report.component.css'],
  standalone: false
})
export class itideadstockreportComponent {
