...
import { ApprenticeshipDeploymentComponent } from '../apprenticeship-deployment/apprenticeship-deployment.component';
import { SSOLoginDataModel } from '../../../../Models/SSOLoginDataModel';
import { Router, ActivatedRoute } from '@angular/router';
import { CommonFunctionService } from '../../../../Services/CommonFunction/common-function.service';
import { LoaderService } from '../../../../Services/Loader/loader.service';
import { ToastrService } from 'ngx-toastr';
import { ApprenticeshipTeamComponent } from '../apprenticeship-team/apprenticeship-team.component';

@Component({
  selector: 'app-add-apprenticeship',
  standalone: false,
  templateUrl: './add-apprenticeship.component.html',
  styleUrl: './add-apprenticeship.component.css'
})
export class AddApprenticeshipComponent {
  ...
  tabs =
    [
      { TabName: 'Apprenticeship Team', TabNameHI: 'निरीक्षण दल', component: ApprenticeshipTeamComponent, TabIcon: 'ti ti-user' },
      { TabName: 'Apprenticeship Team Deployment', TabNameHI: 'निरीक्षण दल की तैनाती', component: ApprenticeshipDeploymentComponent, TabIcon: 'ti ti-license' },
  ...
  async ngOnInit() {
    ...
    this.activatedRoute.queryParams.subscribe((params) => {
      ...
      if (this.ApprenticeshipTeamID != 0 && this.ApprenticeshipTeamID != null && this.ApprenticeshipTeamID != undefined) {
