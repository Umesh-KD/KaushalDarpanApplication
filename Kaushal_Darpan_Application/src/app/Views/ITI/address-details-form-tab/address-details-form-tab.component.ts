...
@Component({
    selector: 'app-address-details-form-tab',
    templateUrl: './address-details-form-tab.component.html',
    styleUrls: ['./address-details-form-tab.component.css'],
    standalone: false
})
export class AddressDetailsFormTabComponent implements OnInit {
