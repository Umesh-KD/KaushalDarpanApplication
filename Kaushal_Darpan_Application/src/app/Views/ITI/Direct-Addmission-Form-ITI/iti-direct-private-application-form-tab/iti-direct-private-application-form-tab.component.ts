...
@Component({
  selector: 'app-iti-direct-private-application-form-tab',
  standalone: false,
  templateUrl: './iti-direct-private-application-form-tab.component.html',
  styleUrl: './iti-direct-private-application-form-tab.component.css'
})
export class ITIDirectprivateApplicationFormTabComponent {
