...
import { ITIDirectprivateApplicationFormTabRoutingModule } from './iti-direct-private-application-form-tab-routing.module';
...
@NgModule({
  declarations: [
    ITIDirectprivateApplicationFormTabComponent,
  ...
  imports: [
    CommonModule,
    ITIDirectprivateApplicationFormTabRoutingModule,
    FormsModule,
    ReactiveFormsModule,
    LoaderModule,
    MaterialModule,
...
export class ITIDirectprivateApplicationFormTabModule { }
