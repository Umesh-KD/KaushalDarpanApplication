...
@Component({
  ...
  selector: 'app-examiner-dispatch-verify',
  standalone: false,
  templateUrl: './examiner-dispatch-verify.component.html',
  styleUrl: './examiner-dispatch-verify.component.css'
})
  export class ExaminerDispatchVerifyComponent {
  ...
  @ViewChild('otpModal') childComponent!: OTPModalComponent;
    ...
    async getgroupteacherData() {
      ...
      try {
        await this.DispatchService.getgroupExaminerData(this.searchRequest).then((data: any) => {
          data = JSON.parse(JSON.stringify(data));
  ...
  async CheckOtpAfterSave() {
    ...
    Selected.forEach((e: any) => { e.Status = 20, e.ModifyBy = this.sSOLoginDataModel.UserID })
    this.loaderService.requestStarted();
