...
@Component({
  selector: 'app-DispatchSuperintendentAllottedExamDateList',
  templateUrl: './DispatchSuperintendentAllottedExamDateList.component.html',
  styleUrls: ['./DispatchSuperintendentAllottedExamDateList.component.css'],
  standalone: false
})
export class DispatchSuperintendentAllottedExamDateListComponent implements OnInit {
  ...
  public DispatchSuperintendentAllottedExamDateList: any = [];
  ...
  async ngOnInit() {
    ...
    await this.getDispatchSuperintendentAllottedExamDateList();
    this.GetStatusType()
    this.statusCh = 0;
    this.Searchrequest.Status = 16;
  }

  get _DispatchForm() { return this.DispatchForm.controls; }
  get _SearchForm() { return this.SearchForm.controls; }

  async getDispatchSuperintendentAllottedExamDateList() {
    ...
    try {
      ...
      await this.dispatchService.DispatchSuperintendentAllottedExamDateList(this.Searchrequest)
        .then((data: any) => {
          data = JSON.parse(JSON.stringify(data));
          this.State = data['State'];
          this.Message = data['Message'];
          this.ErrorMessage = data['ErrorMessage'];
          this.DispatchSuperintendentAllottedExamDateList = data['Data'];
          if (this.DispatchSuperintendentAllottedExamDateList.length < 1) {
            /*this.IsDisplay = false*/
          }
          console.log(this.DispatchSuperintendentAllottedExamDateList)
        ...
        .then((data: any) => {
          ...
          const updatedList = rawList.map((item: any) => {
                ...
                if (item.ID === this._DispatchDDlValue.ReceivedAtBterFromCenter) {
                  return { ...item, Name: 'Received at Bter' };
                }
                return item;
          });
  ...
  //    const data: any = await this.commonMasterService.GetddlCenterDownloadOrReceived(type);
  //    const responseData = JSON.parse(JSON.stringify(data));
  //    const rawList = responseData?.Data?.StatusTypes || [];
  ...
  async searchBundelDataByDate(date: string) {
    try {
      ...
      this.SearchBundelrequest.CenterCode = "001";
