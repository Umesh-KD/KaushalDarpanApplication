...
@Component({
  selector: 'app-correct-document-form-details',
  standalone: false,
  templateUrl: './correct-document-form-details.component.html',
  styleUrl: './correct-document-form-details.component.css'
})
export class CorrectDocumentFormDetailsComponent {
