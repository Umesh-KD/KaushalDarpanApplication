...
@Component({
  selector: 'app-correct-qualification-details',
  standalone: false,
  templateUrl: './correct-qualification-details.component.html',
  styleUrl: './correct-qualification-details.component.css'
})
export class CorrectQualificationDetailsComponent {
      ...
      async (result: any) => {
        if (result.isConfirmed) {
          try {
            ...
            if (this.request.CourseType == EnumCourseType.Lateral || this.request.CourseType == 5 || this.request.CourseType == 4) {
              await this.RefreshValidators()
            ...
            this.request.isCorrectMerit = true
            //save
        ...
        .then((data: any) => {
          ...
          if (data['Data'] != null) {
            ...
            if (this.request.CourseType == 4 && this.request.HighestQualificationModel.length > 1) {
              ...
              //   this.EnglishQualificationForm.patchValue({
              //   RollNumberEnglish: engqua[0].RollNumberHigh,
              //   MaxMarksEnglish: engqua[0].MaxMarksHigh,
              //   MarksObtainedEnglish: engqua[0].MarksObtainedHigh,
              //   PercentageEnglish: engqua[0].PercentageHigh,
              //   StateOfStudyEnglish: engqua[0].StateIDHigh,
              //   UniversityBoardEnglish: engqua[0].UniversityBoard,
              //   YearofPassingEnglish: engqua[0].YearofPassingHigh,
              //   MarksTypeIDEnglish: engqua[0].MarksTypeIDHigh
              // })
              }
            ...
            if (this.request.LateralEntryQualificationModel == null) {
              ...
              this.GetStream();
              if (this.request.CourseType == 4) { this.GetStreamDegree(); }
