...
@Component({
  selector: 'app-direct-seat-metrix',
  standalone: false,

  templateUrl: './direct-seat-metrix.component.html',
  styleUrl: './direct-seat-metrix.component.css'
})
export class BTERSeatMetrixListComponent {
    ...
    try {
      ...
      await this.BTERCollegeTradeService.BTERManagementType()
        .then((data: any) => {
          ...
          console.log(this.ListBTERManagementType, "ListBTERManagementType")
      ...
      await this.BTERCollegeTradeService.BTERTradeScheme()
        .then((data: any) => {
          ...
          console.log(this.ListBTERTradeScheme, "ListBTERTradeScheme")
        }, error => console.error(error));
    ...
    try {
      ...
      await this.BTERCollegeTradeService.getBTERCollegeByManagement(this.searchRequest)
        .then((data: any) => {
          ...
          console.log(this.ListBTERCollegeByManagement, "ListBTERCollegeByManagement")
        }, error => console.error(error));
    }
    catch (Ex) {
      console.log(Ex);
    ...
    try {
      ...
      await this.BTERCollegeTradeService.getBTERTrade(this.searchRequest)
        .then((data: any) => {
          ...
          console.log(this.ListBTERTrade, "ListBTERTrade")
        }, error => console.error(error));
    }
    catch (Ex) {
      console.log(Ex);
  ...
  async GetTradeAndColleges(i: any) {
    ...
    try {
      ...
      this.searchRequest.StreamFor = 1;
      ...
      this.loaderService.requestStarted();
      await this.BTERCollegeTradeService.GetDirectTradeAndColleges(this.searchRequest)
        .then((data: any) => {
          data = JSON.parse(JSON.stringify(data));
          ...
          console.log(this.ListBTERCollegeTrade, "ListBTERCollegeTrade")
        }, error => console.error(error));
    }
    catch (Ex) {
      console.log(Ex);
        ...
        .then((data: any) => {
          ...
          if (data.State === EnumStatus.Success) {
            ...
            const unwantedColumns = [
              "TradeSchemeId", "SeatNotAvailable", "TotalRecords", "CollegeTradeId", "CollegeId", "TradeId", 'IsLockFirstAllotment', 'IsLockSecondAllotment', 'IsLockInternaAllotment', 'TotalM', 'TotalF'
    ...
    this.Swal2.Confirmation("Are you sure you want to Publish Seat Matrix? <br> " +
      ...
      async (result: any) => {
        ...
        if (result.isConfirmed) {
          ...
          await this.childComponent1.onVerified.subscribe(() => {
            ...
            try {
              ...
              requestData.IPAddress = "";
               ...
               this.BTERCollegeTradeService.PublishSeatMatrix(requestData)
                .then(async (data: any) => {
