...
@Component({
  ...
  standalone: false,
  templateUrl: './RelievingTransferRequestReport.component.html',
 
  styleUrl: './RelievingTransferRequestReport.component.css'
})

export class RelievingTransferRequestReportComponent {
