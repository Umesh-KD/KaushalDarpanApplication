...
@Component({
  selector: 'app-dte-nodal-dashboard',
  standalone: false,
  templateUrl: './dte-nodal-dashboard.component.html',
  styleUrl: './dte-nodal-dashboard.component.css'
})
export class DteNodalDashboardComponent {
  ...
  async GetDTEDashboard() {
    ...
    try {
      ...
      await this.verifierService.GetDteNodalVerifierDashboard(this.searchRequest)
        .then((data: any) => {
