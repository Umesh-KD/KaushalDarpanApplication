...
export class ViewApplicationComponent {
  ...
  public EnglishQualificationView: any = [];
        ...
        .then((data: any) => {
          ...
          if (data['Data'] != null) {
            ...
            if (this.request?.DocumentDetailList) {
              ...
              this.filteredDocumentDetails = this.documentDetails.filter((x) => x.GroupNo === 1 && x.Status != 5);
            } else {
              this.documentDetails = [];
              this.filteredDocumentDetails = [];
            }
            ...
            if (this.request.CourseTypeID == 3) {
             ...
             if(this.request.CourseTypeID == 4 || this.request.CourseTypeID == 5) {
              ...
              this.EnglishQualificationView = this.request.QualificationViewDetails.filter(function (dat: any) { return dat.QualificationID == 'English' });
              this.EnglishQualificationView[0].BoardTypeName = this.EnglishQualificationView[0].UniversityBoard
            } 
