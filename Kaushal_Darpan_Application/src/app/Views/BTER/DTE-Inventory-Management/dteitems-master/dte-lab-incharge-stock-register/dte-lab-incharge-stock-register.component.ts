...
@Component({
  selector: 'app-dte-lab-incharge-stock-register',
  templateUrl: './dte-lab-incharge-stock-register.component.html',
  styleUrls: ['./dte-lab-incharge-stock-register.component.css'],
  standalone: false
})
