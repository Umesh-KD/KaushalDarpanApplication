...
@Component({
  selector: 'app-dteequipments-master',
  templateUrl: './dteequipments-master.component.html',
  styleUrls: ['./dteequipments-master.component.css'],
  standalone: false
})
export class DteEquipmentsMasterComponent {
  ...
  constructor(
    ...
    private dteEquipmentsService: DTEEquipmentsMasterService,
  ...
  async GetAllData() {
    try {
      ...
      await this.dteEquipmentsService.GetAllData(this.Searchrequest)
        .then((data: any) => {
          data = JSON.parse(JSON.stringify(data));
          this.State = data['State'];
          this.Message = data['Message'];
      ...
      async (result: any) => {
        ...
        if (result.isConfirmed) {
          try {
            ...
            await this.dteEquipmentsService.DeleteDataByID(CategoryId, this.UserID)
              .then(async (data: any) => {
                data = JSON.parse(JSON.stringify(data));
                console.log(data);
