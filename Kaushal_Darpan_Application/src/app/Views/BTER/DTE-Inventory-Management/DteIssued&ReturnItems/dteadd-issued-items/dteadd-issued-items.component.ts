...
import { IssuedItemDataModel } from '../../../../../Models/IssuedSearchModel';
...
import { ItemsSearchModel } from '../../../../../Models/ItemsDataModels';
...
@Component({
  selector: 'app-dteadd-issued-items',
  templateUrl: './dteadd-issued-items.component.html',
  styleUrls: ['./dteadd-issued-items.component.css'],
  standalone: false
})
export class DteAddIssuedItemsComponent {
  ...
  async saveData() {
    ...
    try {
      ...
      await this.dteIssuedItemsService.SaveData(this.request)
        .then((data: any) => {
  ...
  async GetByID(id: number) {
    ...
    try {
      ...
      await this.dteIssuedItemsService.GetByID(id)
        .then((data: any) => {
          console.log(data)
