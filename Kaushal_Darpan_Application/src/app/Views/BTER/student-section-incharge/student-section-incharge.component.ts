...
@Component({
  selector: 'app-student-section-incharge',
  standalone: false,
  templateUrl: './student-section-incharge.component.html',
  styleUrl: './student-section-incharge.component.css'
})

export class StudentSectionInchargeComponent {
  ...
  async GetAllData() {
    ...
    try {
      ...
      await this.examinerService.SectionInchargeDashboard(this.examinerDashboardSearchModelReq)
        .then((data: any) => {
