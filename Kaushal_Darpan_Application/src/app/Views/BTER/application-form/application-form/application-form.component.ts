...
export class ApplicationFormComponent {
  ...
  tabs = [
    { TabName: 'Applicant Details', TabNameHI: 'आवेदक विवरण', TabIcon: 'ti ti-school', component: DTEStudentJanAadharDetailComponent, Disabled: false },
    /*  { TabName: 'Personal Details', TabNameHI: 'व्यक्तिगत विवरण', TabIcon: 'ti ti-user', component: PersonalDetailsComponent, Disabled: false },*/
    { TabName: 'Address Details', TabNameHI: 'पते का विवरण', TabIcon: 'ti ti-map-pin', component: AddressFormComponent, Disabled: true },
    { TabName: 'Other Details', TabNameHI: 'अन्य विवरण', TabIcon: 'ti ti-notes', component: DTEOtherDetailsFormComponent, Disabled: true },
    { TabName: 'Qualification Detail', TabNameHI: 'योग्यता विवरण', TabIcon: 'ti ti-school', component: QualificationFormComponent, Disabled: true },
    { TabName: 'Option Form', TabNameHI: 'विकल्प प्रपत्र', TabIcon: 'ti ti-license', component: OptionalFormComponent, Disabled: true },
    { TabName: 'Documents', TabNameHI: 'दस्तावेज़', TabIcon: 'ti ti-file', component: DocumentFormComponent, Disabled: true },
