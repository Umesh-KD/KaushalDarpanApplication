...
@Component({
  selector: 'app-direct-personal-details',
  templateUrl: './direct-personal-details.component.html',
  styleUrls: ['./direct-personal-details.component.css'],
    standalone: false
})
export class DirectPersonalDetailsComponent implements OnInit {
