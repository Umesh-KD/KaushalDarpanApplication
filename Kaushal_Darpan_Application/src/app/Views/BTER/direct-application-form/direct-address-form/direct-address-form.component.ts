...
@Component({
    selector: 'app-direct-address-form',
    templateUrl: './direct-address-form.component.html',
    styleUrls: ['./direct-address-form.component.css'],
    standalone: false
})
export class DirectAddressFormComponent {
  ...
  public oldCoreDistrictID: number = 0; 
  ...
  EnableDisableCorsAddressDetail(isSelected: boolean)
  {
    ...
    if (isSelected)
    {
      ...
      this.CorsAddressDetailsFormGroup.controls['CorsNonRajasthanBlockName'].disable();
    ...
    } else
    {
      ...
      this.CorsAddressDetailsFormGroup.controls['CorsNonRajasthanBlockName'].enable();
    }
  }
      ...
      await this.commonMasterService.DistrictMaster_StateIDWise(this.formData.StateID)
        .then((data: any) => {
          ...
          if (this.isSameAddress) {
            this.DistrictCorMasterList = this.DistrictMasterList;
          }
        }, error => console.error(error));
    }
    catch (Ex) {
    ...
    try {
      ...
      await this.commonMasterService.TehsilMaster_DistrictIDWise(this.formData.DistrictID)
        .then((data: any) => {
          ...
          if (this.isSameAddress) {         
            this.DistrictCorMasterList = this.DistrictMasterList;          
            this.TehsilCorMasterList = this.TehsilMasterList;
          }
        }, error => console.error(error));
    }
    catch (Ex) {
  ...
  async saveAddressDetails() {
    ...
    try {
     ...
     /* this.ValidateBlockTehsil();*/
      ...
      if (this.formData.AddressLine3 == null) {
        this.formData.AddressLine3 = "";
      }
      if (this.formData.CityVillage == null) {
        this.formData.CityVillage = "";
      }
      if (this.formData.CorsAddressLine3 == null) {
        this.formData.CorsAddressLine3 = "";
      }
      if (this.formData.CorsCityVillage == null) {
      ...
      await this.ApplicationService.GetAddressDatabyID(this.searchrequest)
        ...
        debugger
          if (data['Data'] != null) {
            ...
            this.oldDistrictID = data['Data']['DistrictID'];
            this.oldCoreDistrictID = data['Data']['CorsDistrictID'];
            ...
            this.formData.DistrictID = this.oldDistrictID;
            this.formData.CorsDistrictID = this.oldCoreDistrictID;
