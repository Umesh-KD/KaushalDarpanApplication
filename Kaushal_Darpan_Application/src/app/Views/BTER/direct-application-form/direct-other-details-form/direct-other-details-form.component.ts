...
@Component({
  selector: 'app-direct-other-details-form',
  templateUrl: './direct-other-details-form.component.html',
  styleUrls: ['./direct-other-details-form.component.css'],
    standalone: false
})
export class DirectDTEOtherDetailsFormComponent
{
  ...
  async SaveData() {
    try {
      ...
      if(this.formData.IsSportsQuota == undefined) {
        this.toastr.error("Please Select Sports Quota")
        return
      }
