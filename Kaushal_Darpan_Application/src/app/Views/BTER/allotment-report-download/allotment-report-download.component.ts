...
@Component({
  selector: 'app-allotment-report-download',
  standalone: false,
  templateUrl: './allotment-report-download.component.html',
  styleUrl: './allotment-report-download.component.css'
})
export class AllotmentReportDownloadComponent {
