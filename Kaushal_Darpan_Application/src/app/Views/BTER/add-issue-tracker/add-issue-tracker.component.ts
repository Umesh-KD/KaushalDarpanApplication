...
import { IssueFile, IssueTrackerDataModels } from '../../../Models/IssueTrackerDataModels';
...
export class AddIssueTrackerComponent {
  ...
  StatusTypeList = [
    ...
    { StatusID: 4, Status: 'More Info' },
    { StatusID: 5, Status: 'Forword' }
  ];
  ...
  async ngOnInit() {
    ...
    this._IssueTrackerFormGroup = this.fb.group({
      ...
      txtProjectName: [{ value: 'Kaushal Darpan', disabled: true }, Validators.required],
