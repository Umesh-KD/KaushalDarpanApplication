...
export class StudentJanAadharDetailComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    if (this.IsDirectAdmission) {
      ...
      if (this.DepartmentID == EnumDepartment.ITI && this.sSOLoginDataModel.RoleID != EnumRole.Emitra && this.sSOLoginDataModel.RoleID != EnumRole.Principal_NCVT && this.sSOLoginDataModel.RoleID != EnumRole.ITIPrincipal) {
        this.GetApplicationId('SearchBySSO')
      }
      // }
      console.log("nothing")
