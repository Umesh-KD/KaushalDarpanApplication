...
@Component({
  selector: 'app-session-configuration-bter',
  templateUrl: './session-configuration-bter.component.html',
  styleUrls: ['./session-configuration-bter.component.css'],
  standalone: false
})
export class SessionConfigurationBTERComponent implements OnInit, OnDestroy {
