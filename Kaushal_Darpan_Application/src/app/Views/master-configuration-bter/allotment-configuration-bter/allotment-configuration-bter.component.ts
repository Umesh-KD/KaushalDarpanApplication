...
@Component({
  selector: 'app-allotment-configuration-bter',
  standalone: false,
  templateUrl: './allotment-configuration-bter.component.html',
  styleUrl: './allotment-configuration-bter.component.css'
})
export class AllotmentConfigurationBTERComponent implements OnInit, OnDestroy {
