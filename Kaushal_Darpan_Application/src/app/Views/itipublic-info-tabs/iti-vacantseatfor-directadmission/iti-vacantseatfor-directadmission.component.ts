...
@Component({
  selector: 'app-iti-vacantseatfor-directadmission',
  templateUrl: './iti-vacantseatfor-directadmission.component.html',
  styleUrl: './iti-vacantseatfor-directadmission.component.css',
  standalone: false
})
export class ItiVacantSeatDirectAdmissionComponent {
  ...
  public  request1= new ItiCollegeModel();
  ...
  async ddlDistrict_Change() {
   ...
   /* this.request.PanchayatsamityId = 0*/
    try {
      ...
      this.request1.CollegeID = 0;
      this.loaderService.requestStarted();
      this.collegeRequest.action="_getDatabyDistrict"
  ...
  //  debugger
    if (
      ...
      this.ValidationMessage = "Please select college";
      // this.ITICollegeList = [];
  ...
  async GetList() {
    try {
      // debugger
      this.loaderService.requestStarted();
      await this.ApplicationService.ItiVacantSeatForDirectAdmission(this.request1)
        .then((data: any) => {
          data = JSON.parse(JSON.stringify(data));
          this.ITIVacantSeatList = data['Data'];
          this.loadInTable();
          console.log(this.ITIVacantSeatList, "ITIVacantSeatList")
        }, error => console.error(error));
    }
    catch (Ex) {
      console.log(Ex);
  ...
  updateInTablePaginatedData() {
    ...
    this.paginatedInTableData = [...this.ITIVacantSeatList].slice(this.startInTableIndex, this.endInTableIndex);
    this.loaderService.requestEnded();
  }
  previousInTablePage() {
  ...
  resetInTableValiable() {
    ...
    this.totalInTableRecord = this.ITIVacantSeatList.length;
  }
