...
const routes: Routes = [
  ...
  { path: 'Views\ITI\Examination\ScvtExamAttendence', loadChildren: () => import('./Views/ITI/Examination/scvt-exam-attendence/scvt-exam-attendence.module').then(m => m.ScvtExamAttendenceModule) },
