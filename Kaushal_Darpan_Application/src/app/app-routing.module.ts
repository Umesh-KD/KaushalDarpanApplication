...
const routes: Routes = [
  ...
  { path: 'Views\ITI\NodalStudentCorrectionMaster', loadChildren: () => import('./Views/ITI/nodal-student-correction-master/nodal-student-correction-master.module').then(m => m.NodalStudentCorrectionMasterModule) },
