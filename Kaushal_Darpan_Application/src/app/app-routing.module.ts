...
const routes: Routes = [
...

  {
    ...
    children: [
      ...
      { path: 'add-iip-events/:id', loadChildren: () => import('./Views/IndustryInstitutePartnershipMaster/add-iip-events/add-iip-events.module').then(m => m.AddIIPEventsModule), title: 'Add IIP Events' },
      ...
      { path: 'iticollegeapprovedcontractrpt/:id/:instituteId/:monthId/:yearId', loadChildren: () => import('./Views/ITI/ITI-Apprenticeship/iti-college-approved-contract-rptdetails/iti-college-approved-contract-rptdetails.module').then(m => m.ItiCollegeApprovedContractRPTDetailsModule), title: 'Pre Exam Student Examination' },
      ...
      { path: 'IIP-ManageAdmin-report', loadChildren: () => import('./Views/ITI/IIP-Module/iip-manage-admin-report/iip-manage-admin-report.module').then(m => m.IIPManageAdminReportModule), title: 'ITI IIP Manage' },
      //{ path: 'verify-iti-inspection', loadChildren: () => import('./Views/ITI/Inspection/verify-iti-inspection/verify-iti-inspection.module').then(m => m.VerifyITIInspectionModule), title: 'ITI Inspection' },
      //{ path: 'iti-inspection-report', loadChildren: () => import('./Views/ITI/Inspection/iti-inspection-report/iti-inspection-report.module').then(m => m.ITIInspectionReportModule), title: 'ITI Inspection Report' },
      ...
      {
        path: 'iti-students-upgraded-by-upward', loadChildren: () => import('./Views/ITI/students-upgraded-by-upward/students-upgraded-by-upward.module').then(m =>
          m.StudentUpgradedByUpwardModule), title: 'iti-students-upgraded-by-upward'
      },
      ...
      { path: 'AddTransferRequest/:ID', loadChildren: () => import('./Views/BTER/EM-TransferModule/AddTransferRequest/AddTransferRequest.module').then(m => m.AddTransferRequestModule) },
      ...
      { path: 'RelievingTransferProcessList', loadChildren: () => import('./Views/BTER/EM-TransferModule/RelievingTransferList/RelievingTransferList.module').then(m => m.RelievingTransferListModule) },
