...
const routes: Routes = [
  ...
  
  {
    path: 'allotment-report-admin', loadChildren: () => import('./Views/ITI/reports/allotment-report-college-admin/allotment-report-college-admin.module').
      ...
      { path: 'IIP-ManageAdmin-report', loadChildren: () => import('./Views/ITI/IIP-Module/iip-manage-admin-report/iip-manage-admin-report.module').then(m => m.IIPManageAdminReportModule) },
