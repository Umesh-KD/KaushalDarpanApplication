...
import { DocumentDetailList, ExperienceDetailsDataModel } from "./ITIFormDataModel";
...
export class PreviewDirectApplicationModel {
  public ApplicationID: number = 0;
  public StudentName: string = '';
  public StudentNameHindi: string = '';
  public FatherName: string = '';
  ...
  public PendingDataModel: PendingDataModel[] = [];
  public DocumentDetailList: DocumentDetailsModel[] = [];
  public ExperienceDetailsDataModel: ExperienceDetailsDataModel[] = [];
  public IsFinalPay: boolean = false
