export class ITITimeTableDataModels {
  ...
  public TradeSubjectDataModel: TradeSubjectDataModel[] = [];
  public TradeID: number = 0;
  public Eng_NonEng: number = 0;
  public SubjectName: string = '';
  public TradeName: string = 'All';
}

export class TradeSubjectDataModel {
  public SubjectID: number = 0;
  public SubjectName: string = '';
  public TradeID: number = 0;
...
export class ITICBTCenterModel {
  public CBTCenterID: number = 0;
  public EndTermID: number = 0;
}
