...
export class ITIGovtEMStaffMaster {
  ...
  public async ITI_IsAdditionUserOfficeSave(request: any) {
    debugger
    var body = JSON.stringify(request);

    return await this.http.post(`${this.APIUrl}/ITI_IsAdditionUserOfficeSave`, body, this.headersOptions)
      .pipe(
        catchError(this.handleErrorObservable)
      ).toPromise();
  }
  ...
  public async Relieving_joining_CheckVacantPostModel(request: ITI_Relieving_joining_CheckVacantPostModel) {
    const body = JSON.stringify(request);
    return await this.http.post(this.APIUrl + '/Relieving_joining_CheckVacantPostModel', body, this.headersOptions)
      .pipe(
        catchError(this.handleErrorObservable)
      ).toPromise();
  }
