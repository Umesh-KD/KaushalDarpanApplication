...
export class ReportService {
  ...
  public async UFMCategoryReportPdf_BTER(searchRequest: any) {
    var body = JSON.stringify(searchRequest);
    return await this.http.post(`${this.APIUrl}/UFMCategoryReportPdf_BTER`, body, this.headersOptions)
      .pipe(
        catchError(this.handleErrorObservable)
      ).toPromise();
  }
  ...
  async GetPassoutApprenticeship(obj: any) {

    const headers = { 'content-type': 'application/json' };

    return await this.http.post(
      this.APIUrl + "/ApprenticeshipPassoutReport",
      obj,
      {
        headers: headers,
        responseType: 'blob'
  ...
  public async PmnamMelaReportnodelOfficer(obj: any) {
   ...
   public async DownloadAppearedPassed(request: DownloadAppearedPassed) {
      const body = JSON.stringify(request);
      return this.http.post(`${this.APIUrl}/DownloadAppearedPassed`, body, this.headersOptions)
        .pipe(
          catchError(this.handleErrorObservable)
        ).toPromise();
  }

  public async DownloadAppearedPassedInstitutewise(request: DownloadAppearedPassedInstitutewise) {
    const body = JSON.stringify(request);
    return this.http.post(`${this.APIUrl}/DownloadAppearedPassedInstitutewise`, body, this.headersOptions)
      .pipe(
        catchError(this.handleErrorObservable)
      ).toPromise();
  }
