...
export class DTEEquipmentsMasterService {
  readonly APIUrl = this.appsettingConfig.apiURL + "DTEEquipmentsMaster";
  ...
  public async SaveData(request: DTEEquipmentsDataModel) {
