...
export class DTELaboratoryMasterService {
  readonly APIUrl = this.appsettingConfig.apiURL + "DTELaboratoryMaster";
  ...
  public async SaveData(request: DTELaboratoryDataModel) {
