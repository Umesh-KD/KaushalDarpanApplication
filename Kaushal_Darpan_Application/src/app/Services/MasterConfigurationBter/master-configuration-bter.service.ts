...
import { FeeConfigurationBterModel, SerialMasterConfigurationBterModel } from '../../Models/MasterConfigurationBterModel';

@Injectable({
  providedIn: 'root'
})

export class MasterConfigurationBterService {

  readonly APIUrl = this.appsettingConfig.apiURL + "MasterConfigurationBter";
  ...
  //Get all data
  public async GetAllFeeData(request: FeeConfigurationBterModel) {
  ...
  public async SaveFeeData(request: FeeConfigurationBterModel) {
    const body = JSON.stringify(request);
  ...
  // Serial master
  public async GetAllSerialData(request: SerialMasterConfigurationBterModel) {
    const body = JSON.stringify(request);
  ...
  public async SaveSerialData(request: SerialMasterConfigurationBterModel) {
    const body = JSON.stringify(request);
