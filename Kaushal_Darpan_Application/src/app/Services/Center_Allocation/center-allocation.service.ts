...
import { CenterAllocationSearchModel, CenterAllocationtDataModels, CenterSuperintendentOrderStatusModel } from '../../Models/CenterAllocationDataModels';
...
export class CenterAllocationService {
    ...
    public async GetStatusCenterSuperintendentOrder(model: CenterSuperintendentOrderStatusModel) {
        return await this.http.post(this.APIUrl + "/GetStatusCenterSuperintendentOrder", model, this.headersOptions)
            .pipe(
                catchError(this.handleErrorObservable)
            ).toPromise();
    }
