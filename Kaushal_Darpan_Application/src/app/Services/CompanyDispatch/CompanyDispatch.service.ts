...
import { DispatchFormDataModel, BundelDataModel, DispatchSearchModel, DispatchReceivedModel, DownloadDispatchReceivedSearchModel, DispatchPrincipalGroupCodeDataModel, DispatchPrincipalGroupCodeSearchModel, DispatchMasterStatusUpdate, CheckDateDispatchSearchModel, CompanyDispatchIUMasterSearchModel, CompanyDispatchIUMasterModel } from '../../Models/DispatchFormDataModel';
...
export class CompanyDispatchService {
  ...
  public async GetAllData(request: CompanyDispatchIUMasterSearchModel) {
  ...
  public async SaveData(request: CompanyDispatchIUMasterModel) {
