...
export class Board_UniversityMasterService {

  readonly APIUrl = this.appsettingConfig.apiURL + "Board_UniversityMaster";
  ...
  //Get 
  public async GetAllData(model: Board_UniversityMasterSearchModel ) {
  ...
  public async SaveData(request: Board_UniversityMasterModel) {
