...
export class ITICollegeProfileService {

  readonly APIUrl = this.appsettingConfig.apiURL + "ITICollegeProfile";
  ...
  public async SaveData(request: ITICollegeProfileDataModels) {
  ...
  public async UpdateData(PK_ID: number, request: ITICollegeProfileDataModels) {
    const body = JSON.stringify(request);
