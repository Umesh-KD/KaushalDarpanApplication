...
export class EmitraPaymentService
{
  ...
  public async EnrollmentExaminationFeePayment(request: EmitraRequestDetails) {
    const body = JSON.stringify(request);
    return await this.http.post(this.APIUrl + "/EnrollmentExaminationFeePayment", body, this.headersOptions)
      .pipe(
        catchError(this.handleErrorObservable)
      ).toPromise();
  }
  ...
  public async RevalFeePayment_Student(request: EmitraRequestDetails) {
    const body = JSON.stringify(request);
    return await this.http.post(this.APIUrl + "/RevalFeePayment_Student", body, this.headersOptions)
      .pipe(
        catchError(this.handleErrorObservable)
      ).toPromise();
  }
  ...
  public async ITINCVTEXAMVerification(request: TransactionStatusDataModel) {
    const body = JSON.stringify(request);
    return await this.http.post(this.APIUrl + "/ITINCVTEXAMVerification", body, this.headersOptions)
      .pipe(
        catchError(this.handleErrorObservable)
      ).toPromise();
  }
