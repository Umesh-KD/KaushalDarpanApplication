...
import { ItemUnitModel } from '../../Models/ItemUnitModel';

@Injectable({
  providedIn: 'root'
})
export class ItemUnitMasterService {
  readonly APIUrl = this.appsettingConfig.apiURL + "ItemUnitMaster";
  ...
  public async SaveData(request: ItemUnitModel) {
