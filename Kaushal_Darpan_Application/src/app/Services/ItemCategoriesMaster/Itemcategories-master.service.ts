...
export class ItemCategoriesMasterService {
  readonly APIUrl = this.appsettingConfig.apiURL + "ItemCategoryMaster";
  ...
  public async SaveData(request: ItemCategoriesDataModels) {
