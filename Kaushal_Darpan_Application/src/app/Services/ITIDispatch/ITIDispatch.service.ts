...
import {
  ...
  ITI_Dispatch_ShowbundleSearchModel,
  ITI_DispatchBundelNoSendToTheAdminByTheExaminerUpdate
...
import { ITIDispatchGroupDataModel, ITIDispatchGroupSearchModel } from '../../Models/ITIDispatchGroupDataModel';

@Injectable({
  providedIn: 'root'
})
export class ITIDispatchService {
  readonly APIUrl = this.appsettingConfig.apiURL + "ITIDispatchManagement";
  ...
  public async GetAllData(request: ITIDispatchSearchModel) {
  ...
  public async GetBundelDataAllData(request: ITIBundelDataModel) {
    var body = JSON.stringify(request);
  ...
  public async SaveData(request: ITIDispatchFormDataModel) {
  ...
  public async SaveDispatchReceived(request: ITIDispatchReceivedModel[], saveValue: number=0) {
  ...
  public async GetDownloadDispatchReceived(request: ITIDownloadDispatchReceivedSearchModel, saveValue: number = 0) {
  ...
  public async GetGroupDataAllData(request: ITIDispatchGroupSearchModel) {
    var body = JSON.stringify(request);
  ...
  public async SaveDispatchGroup(request: ITIDispatchGroupDataModel) {
  ...
  public async GetAllGroupData(request: ITIDispatchSearchModel) {
    var body = JSON.stringify(request);
  ...
  public async getgroupteacherData(request: ITIDispatchSearchModel) {
    var body = JSON.stringify(request);
  ...
  public async getgroupExaminerData(request: ITIDispatchSearchModel) {
    var body = JSON.stringify(request);
  ...
  public async SaveDispatchPrincipalGroupCodeData(request: ITIDispatchPrincipalGroupCodeDataModel) {
  ...
  public async GetDispatchGroupcodeDetails(request: ITIDispatchPrincipalGroupCodeSearchModel) {
    var body = JSON.stringify(request);
  ...
  public async GetDispatchGroupcodeList(request: ITIDispatchPrincipalGroupCodeSearchModel) {
    var body = JSON.stringify(request);
  ...
  public async GetAllDataDispatchMaster(request: ITIDispatchSearchModel) {
    var body = JSON.stringify(request);
  ...
  public async GetAllReceivedData(request: ITIDispatchSearchModel) {
    var body = JSON.stringify(request);
  ...
  public async OnSTatusUpdateByITI(request: any[]) {
    var body = JSON.stringify(request);
    return await this.http.post(`${this.APIUrl}/OnSTatusUpdateByITI`, body, this.headersOptions)
      .pipe(
        catchError(this.handleErrorObservable)
      ).toPromise();
  }

  public async DownloadAckReportPri(request: ITIDispatchSearchModel) {
    var body = JSON.stringify(request);
  ...
  public async OnSTatusUpdateDispatchMaster(request: ITIDispatchMasterStatusUpdate[]) {
    var body = JSON.stringify(request);
  ...
  public async CheckDateDispatchSearch(request: ITICheckDateDispatchSearchModel ) {
    var body = JSON.stringify(request);
    return await this.http.post(`${this.APIUrl}/OnSTatusUpdateDispatchMaster`, body, this.headersOptions)
      .pipe(
        catchError(this.handleErrorObservable)
  ...
  public async DispatchSuperintendentAllottedExamDateList(request: ITIDispatchSearchModel) {
    var body = JSON.stringify(request);
  ...
  public async UpdateRemarkImageHandedOverToExaminerByPrincipal(request: ITIUpdateFileHandovertoExaminerByPrincipalModel) {
    var body = JSON.stringify(request);
  ...
  public async GetDispatchGroupcodeDetailsCheck(request: ITIDispatchPrincipalGroupCodeSearchModel) {
    var body = JSON.stringify(request);
  ...
  public async SaveCompanyDispatchData(request: ITICompanyDispatchIUMasterModel) {

    const body = JSON.stringify(request);
    return await this.http.post(this.APIUrl + '/SaveDataCompanyDispatch', request, this.headersOptions)
      .pipe(
        catchError(this.handleErrorObservable)
      ).toPromise();
  }

  public async DeleteDataCompanyDispatchByID(ID: number, userId: number) {
    var body = JSON.stringify({ "ID": ID, "ModifyBy": userId });
    return await this.http.delete(`${this.APIUrl}/DeleteDataCompanyDispatchByID/${ID}/${userId}`, this.headersOptions)
      .pipe(
        catchError(this.handleErrorObservable)
      ).toPromise();
  }

  public async GetAllData_CompanyDispatchList(request: ITICompanyDispatchIUMasterSearchModel) {
    var body = JSON.stringify(request);
    return await this.http.post(`${this.APIUrl}/GetAllDataCompanyDispatch`, body, this.headersOptions)
      .pipe(
        catchError(this.handleErrorObservable)
      ).toPromise();
  }
  ...
  public async GetITI_Dispatch_Showbundle(request: ITI_Dispatch_ShowbundleSearchModel) {
    var body = JSON.stringify(request);
    return await this.http.post(`${this.APIUrl}/GetITI_Dispatch_Showbundle`, body, this.headersOptions)
      .pipe(
        catchError(this.handleErrorObservable)
      ).toPromise();
  }
  ...
  public async GetITI_Dispatch_ShowbundleByData(request: ITI_Dispatch_ShowbundleSearchModel) {
    var body = JSON.stringify(request);
    return await this.http.post(`${this.APIUrl}/GetITI_Dispatch_ShowbundleByData`, body, this.headersOptions)
      .pipe(
        catchError(this.handleErrorObservable)
      ).toPromise();
  }

  public async GetITI_Dispatch_ShowbundleByAdminToExaminerData(request: ITI_Dispatch_ShowbundleSearchModel) {
    var body = JSON.stringify(request);
    return await this.http.post(`${this.APIUrl}/GetITI_Dispatch_ShowbundleByAdminToExaminerData`, body, this.headersOptions)
      .pipe(
        catchError(this.handleErrorObservable)
      ).toPromise();
  }

  public async GetITI_Dispatch_ShowbundleByExaminerToAdminData(request: ITI_Dispatch_ShowbundleSearchModel) {
    var body = JSON.stringify(request);
